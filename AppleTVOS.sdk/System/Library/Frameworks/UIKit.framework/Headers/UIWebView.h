...
UIKIT_EXTERN API_DEPRECATED("No longer supported; please adopt WKWebView.", ios(2.0, 12.0))  API_UNAVAILABLE(macos) @interface UIWebView : UIView <NSCoding, UIScrollViewDelegate>
