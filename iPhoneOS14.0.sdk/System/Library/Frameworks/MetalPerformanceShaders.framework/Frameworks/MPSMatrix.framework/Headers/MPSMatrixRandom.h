...
#endif
{
    ...
    MPSMatrixRandomDistributionNormal       MPS_ENUM_AVAILABLE_STARTING(macos(10.16), ios(14), macCatalyst(14), tvos(14)) MPS_SWIFT_NAME(normal) = 3U
};
...
MPS_AVAILABLE_STARTING(macos(10.16), ios(14), macCatalyst(14), tvos(14));
