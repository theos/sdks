...
} NS_ENUM_AVAILABLE(10_16, 13_0) NS_SWIFT_NAME(CBCentralManager.Feature);
 ...
 *
 */
+ (BOOL)supportsFeatures:(CBCentralManagerFeature)features NS_AVAILABLE(10_16, 13_0) NS_SWIFT_NAME(supports(_:));
 ...
 */
- (void)registerForConnectionEventsWithOptions:(nullable NSDictionary<CBConnectionEventMatchingOption, id> *)options NS_AVAILABLE(10_16, 13_0);
 ...
 *
 */
- (void)centralManager:(CBCentralManager *)central connectionEventDidOccur:(CBConnectionEvent)event forPeripheral:(CBPeripheral *)peripheral NS_AVAILABLE(10_16, 13_0);
