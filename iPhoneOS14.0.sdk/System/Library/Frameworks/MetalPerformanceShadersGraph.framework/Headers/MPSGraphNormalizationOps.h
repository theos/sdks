...
*/
-(MPSGraphTensor *) meanWithTensor:(MPSGraphTensor *) tensor
 ...
 * @return     A valid MPSGraphTensor object.
*/
-(MPSGraphTensor *) varianceWithTensor:(MPSGraphTensor *) tensor
 ...
 *
 *
 * @param      meanTensor                     mean
 * @param      varianceTensor            variance
