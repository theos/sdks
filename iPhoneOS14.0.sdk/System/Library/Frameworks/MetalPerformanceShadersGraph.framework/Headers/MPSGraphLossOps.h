...
{
    MPSGraphLossReductionTypeAxis                                            MPS_ENUM_AVAILABLE_STARTING(macos(10.16), ios(14.0), tvos(14.0)) MPS_SWIFT_NAME(none) =   0,
    MPSGraphLossReductionTypeSum                                             MPS_ENUM_AVAILABLE_STARTING(macos(10.16), ios(14.0), tvos(14.0))                      =   1L,
};
 ...
 */
-(MPSGraphTensor *) softMaxCrossEntropyLossWithSourceTensor:(MPSGraphTensor *) sourceTensor
