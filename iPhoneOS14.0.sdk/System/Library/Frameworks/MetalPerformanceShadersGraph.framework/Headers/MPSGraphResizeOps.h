...
{
    MPSGraphResizeNearest        MPS_ENUM_AVAILABLE_STARTING(macos(10.16), ios(14.0), tvos(14.0)) MPS_SWIFT_NAME(explicit)  =  0L,
    MPSGraphResizeBilinear       MPS_ENUM_AVAILABLE_STARTING(macos(10.16), ios(14.0), tvos(14.0))                           =  1L,
};
