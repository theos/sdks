...
{
    MPSGraphTensorNamedDataLayoutNCHW       MPS_ENUM_AVAILABLE_STARTING(macos(10.16), ios(14.0), tvos(14.0)) MPS_SWIFT_NAME(NCHW)   =  0L,
    MPSGraphTensorNamedDataLayoutNHWC       MPS_ENUM_AVAILABLE_STARTING(macos(10.16), ios(14.0), tvos(14.0))                        =  1L,
    MPSGraphTensorNamedDataLayoutOIHW       MPS_ENUM_AVAILABLE_STARTING(macos(10.16), ios(14.0), tvos(14.0))                        =  2L,
    MPSGraphTensorNamedDataLayoutHWIO       MPS_ENUM_AVAILABLE_STARTING(macos(10.16), ios(14.0), tvos(14.0))                        =  3L,
    MPSGraphTensorNamedDataLayoutCHW        MPS_ENUM_AVAILABLE_STARTING(macos(10.16), ios(14.0), tvos(14.0))                        =  4L,
    MPSGraphTensorNamedDataLayoutHWC        MPS_ENUM_AVAILABLE_STARTING(macos(10.16), ios(14.0), tvos(14.0))                        =  5L,
    MPSGraphTensorNamedDataLayoutHW         MPS_ENUM_AVAILABLE_STARTING(macos(10.16), ios(14.0), tvos(14.0))                        =  6L,
};
...
{
    MPSGraphPaddingStyleExplicit       MPS_ENUM_AVAILABLE_STARTING(macos(10.16), ios(14.0), tvos(14.0)) MPS_SWIFT_NAME(explicit)   =  0L,
    MPSGraphPaddingStyleTF_VALID       MPS_ENUM_AVAILABLE_STARTING(macos(10.16), ios(14.0), tvos(14.0))                            =  1L,
    MPSGraphPaddingStyleTF_SAME        MPS_ENUM_AVAILABLE_STARTING(macos(10.16), ios(14.0), tvos(14.0))                            =  2L,
};
...
{
    MPSGraphPaddingModeConstant     MPS_ENUM_AVAILABLE_STARTING(macos(10.16), ios(14.0), tvos(14.0)) MPS_SWIFT_NAME(constant) =  0L,
    MPSGraphPaddingModeReflect      MPS_ENUM_AVAILABLE_STARTING(macos(10.16), ios(14.0), tvos(14.0))                          =  1L,
    MPSGraphPaddingModeSymmetric    MPS_ENUM_AVAILABLE_STARTING(macos(10.16), ios(14.0), tvos(14.0))                          =  2L,
};
