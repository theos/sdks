 ...
 */
static void __unused XGBoostVersion(int* major, int* minor, int* patch);
 ...
 */
static const char __unused *XGBGetLastError(void);
 ...
 */
static int __unused XGBRegisterLogCallback(void (*callback)(const char*));
 ...
 */
static int __unused XGDMatrixCreateFromFile(const char *fname,
                                    int silent,
                                    DMatrixHandle *out);
 ...
 * \return 0 when success, -1 when failure happens.
 */
static int __unused XGDMatrixCreateFromDataIter(
 ...
 * \return 0 when success, -1 when failure happens
 */
static int __unused XGDMatrixCreateFromCSREx(const size_t* indptr,
 ...
 * \return 0 when success, -1 when failure happens
 */
static int __unused XGDMatrixCreateFromCSCEx(const size_t* col_ptr,
                                     const unsigned* indices,
                                     const float* data,
                                     size_t nindptr,
                                     size_t nelem,
 ...
 * \return 0 when success, -1 when failure happens
 */
static int __unused XGDMatrixCreateFromMat_omp(const float *data,  // NOLINT
 ...
 * \return 0 when success, -1 when failure happens
 */
static int __unused XGDMatrixCreateFromDT(void** data,
 ...
 * \return 0 when success, -1 when failure happens
 */
static int __unused XGDMatrixSliceDMatrix(DMatrixHandle handle,
                                  const int *idxset,
                                  bst_ulong len,
                                  DMatrixHandle *out);
/*!
 ...
 * \return 0 when success, -1 when failure happens
 */
static int __unused XGDMatrixSliceDMatrixEx(DMatrixHandle handle,
                                    const int *idxset,
                                    bst_ulong len,
                                    DMatrixHandle *out,
                                    int allow_groups);
 ...
 * \return 0 when success, -1 when failure happens
 */
static int __unused XGDMatrixSaveBinary(DMatrixHandle handle,
 ...
 * \return 0 when success, -1 when failure happens
 */
static int __unused XGDMatrixSetUIntInfo(DMatrixHandle handle,
                                 const char *field,
 ...
 * \return 0 when success, -1 when failure happens
 */
static int __unused XGDMatrixSetGroup(DMatrixHandle handle,
 ...
 * \return 0 when success, -1 when failure happens
 */
static int __unused XGDMatrixGetFloatInfo(const DMatrixHandle handle,
                                  const char *field,
                                  bst_ulong* out_len,
 ...
 * \return 0 when success, -1 when failure happens
 */
static int __unused XGDMatrixGetUIntInfo(const DMatrixHandle handle,
                                 const char *field,
                                 bst_ulong* out_len,
 ...
 * \return 0 when success, -1 when failure happens
 */
static int __unused XGDMatrixNumRow(DMatrixHandle handle,
                            bst_ulong *out);
/*!
 ...
 * \return 0 when success, -1 when failure happens
 */
static int __unused XGDMatrixNumCol(DMatrixHandle handle,
                            bst_ulong *out);
// --- start XGBoost class
/*!
 ...
 * \return 0 when success, -1 when failure happens
 */
static int __unused XGBoosterBoostOneIter(BoosterHandle handle,
                                  DMatrixHandle dtrain,
                                  float *grad,
                                  float *hess,
                                  bst_ulong len);
 ...
 * \return 0 when success, -1 when failure happens
 */
static int __unused XGBoosterEvalOneIter(BoosterHandle handle,
                                 int iter,
                                 DMatrixHandle dmats[],
                                 const char *evnames[],
                                 bst_ulong len,
 ...
 * \return 0 when success, -1 when failure happens
 */
static int __unused XGBoosterLoadModelFromBuffer(BoosterHandle handle,
                                         const void *buf,
                                         bst_ulong len);
/*!
 ...
 * \return 0 when success, -1 when failure happens
 */
static int __unused XGBoosterGetModelRaw(BoosterHandle handle, bst_ulong *out_len,
                                 const char **out_dptr);
 ...
 * \return 0 when success, -1 when failure happens
 */
static int __unused XGBoosterSerializeToBuffer(BoosterHandle handle, bst_ulong *out_len,
                                       const char **out_dptr);
/*!
 ...
 * \return 0 when success, -1 when failure happens
 */
static int __unused XGBoosterUnserializeFromBuffer(BoosterHandle handle,
 ...
 * \return 0 when success, -1 when failure happens
 */
static int __unused XGBoosterLoadRabitCheckpoint(BoosterHandle handle,
                                         int* version);
 ...
 * \return 0 when success, -1 when failure happens
 */
static int __unused XGBoosterSaveRabitCheckpoint(BoosterHandle handle);
 ...
 * \return 0 when success, -1 when failure happens
 */
static int __unused XGBoosterSaveJsonConfig(BoosterHandle handle, bst_ulong *out_len,
                                    char const **out_str);
/*!
 ...
 * \return 0 when success, -1 when failure happens
 */
static int __unused XGBoosterLoadJsonConfig(BoosterHandle handle,
 ...
 * \return 0 when success, -1 when failure happens
 */
static int __unused XGBoosterDumpModel(BoosterHandle handle,
                               const char *fmap,
                               int with_stats,
                               bst_ulong *out_len,
 ...
 * \return 0 when success, -1 when failure happens
 */
static int __unused XGBoosterDumpModelEx(BoosterHandle handle,
                                 const char *fmap,
                                 int with_stats,
                                 const char *format,
                                 bst_ulong *out_len,
 ...
 * \return 0 when success, -1 when failure happens
 */
static int __unused XGBoosterDumpModelWithFeatures(BoosterHandle handle,
                                           int fnum,
                                           const char **fname,
                                           const char **ftype,
                                           int with_stats,
 ...
 * \return 0 when success, -1 when failure happens
 */
static int __unused XGBoosterDumpModelExWithFeatures(BoosterHandle handle,
                                             int fnum,
                                             const char **fname,
                                             const char **ftype,
                                             int with_stats,
 ...
 * \return 0 when success, -1 when failure happens
 */
static int __unused XGBoosterGetAttr(BoosterHandle handle,
                             const char* key,
                             const char** out,
                             int *success);
/*!
 ...
 * \return 0 when success, -1 when failure happens
 */
static int __unused XGBoosterSetAttr(BoosterHandle handle,
                             const char* key,
                             const char* value);
/*!
 ...
 * \return 0 when success, -1 when failure happens
 */
static int __unused XGBoosterGetAttrNames(BoosterHandle handle,
                                  bst_ulong* out_len,
                                  const char*** out);
