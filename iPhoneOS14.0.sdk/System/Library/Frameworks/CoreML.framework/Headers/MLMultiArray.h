...
typedef NS_ENUM(NSInteger, MLMultiArrayDataType) {
    ...
    MLMultiArrayDataTypeFloat64 API_AVAILABLE(macos(10.16), ios(14.0), watchos(7.0), tvos(14.0)) = 0x10000 | 64,
    MLMultiArrayDataTypeFloat32 = 0x10000 | 32,
    MLMultiArrayDataTypeFloat   API_AVAILABLE(macos(10.16), ios(14.0), watchos(7.0), tvos(14.0)) = 0x10000 | 32,
...
+ (instancetype)multiArrayByConcatenatingMultiArrays:(NSArray<MLMultiArray *> *)multiArrays
                                           alongAxis:(NSInteger)axis
                                            dataType:(MLMultiArrayDataType)dataType API_AVAILABLE(macos(10.16), ios(14.0), watchos(7.0), tvos(14.0));
@end
