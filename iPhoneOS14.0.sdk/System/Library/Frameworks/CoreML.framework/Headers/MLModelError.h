...
typedef enum MLModelError : NSInteger {
    ...
    MLModelErrorModelEncryption API_AVAILABLE(macos(10.16), ios(14.0), watchos(7.0), tvos(14.0)) = 8,
    MLModelErrorModelKeyFetch API_AVAILABLE(macos(10.16), ios(14.0), watchos(7.0), tvos(14.0)) = 9,
    MLModelErrorModelDecryption API_AVAILABLE(macos(10.16), ios(14.0), watchos(7.0), tvos(14.0)) = 10,
