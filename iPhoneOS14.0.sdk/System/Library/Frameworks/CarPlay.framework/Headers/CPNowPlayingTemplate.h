...
@protocol CPNowPlayingTemplateDelegate <NSObject>
@optional
...
/**
 ...
 now playing template, you should configure the properties and set the delegate of
 ...
 this shared instance.
 */
+ (instancetype)sharedNowPlayingTemplate;

- (instancetype)init NS_UNAVAILABLE;
+ (instancetype)new NS_UNAVAILABLE;

/**
 The template's delegate is informed of Now Playing events.
 */
@property (nullable, nonatomic, weak) id<CPNowPlayingTemplateDelegate> delegate;
 ...
 */
@property (nonatomic, strong, readonly) NSArray<CPNowPlayingButton *> *nowPlayingButtons;
 ...
 */
- (void)updateNowPlayingButtons:(NSArray <CPNowPlayingButton *> *)nowPlayingButtons;
