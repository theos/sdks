...
/**
 ...
 your templates. For example, images you display in your @c CPListTemplate should use a
 display scale matching the scale of the @c carTraitCollection, not the scale of the
 iOS device's screen.
 */
@property (nonatomic, readonly, strong) UITraitCollection *carTraitCollection;
 ...
 */
- (void)application:(UIApplication *)application didConnectCarInterfaceController:(CPInterfaceController *)interfaceController toWindow:(nullable CPWindow *)window;

/**
 The CarPlay screen has disconnected.
 */
- (void)application:(UIApplication *)application didDisconnectCarInterfaceController:(CPInterfaceController *)interfaceController fromWindow:(nullable CPWindow *)window;
