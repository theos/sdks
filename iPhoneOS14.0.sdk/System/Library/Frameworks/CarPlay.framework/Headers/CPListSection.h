 ...
 */
- (instancetype)initWithItems:(NSArray<__kindof CPBaseListItem *> *)items
 ...
 */
@property (nonatomic, readonly, copy) NSArray <__kindof CPBaseListItem *> *items;

/**
 Search for an item in this section, returning its index
 or @c NSNotFound if not found.
 */
- (NSUInteger)indexOfItem:(__kindof CPBaseListItem *)item;

/**
 Convenience access to the item in this section at the specified index.
 */
- (__kindof CPBaseListItem *)itemAtIndex:(NSUInteger)index;
