...
/**
 ...
 @note An exception will be thrown if your app initializes a list template with more than
 this number of items.
 */
@property (nonatomic, class, readonly) NSUInteger maximumItemCount;
 ...
 */
@property (nonatomic, class, readonly) NSUInteger maximumSectionCount;
 ...
 */
@property (nonatomic, readonly) NSUInteger sectionCount API_AVAILABLE(ios(14_0));

/**
 The number of items currently displayed in this list template, across all sections.
 */
@property (nonatomic, readonly) NSUInteger itemCount API_AVAILABLE(ios(14_0));
 ...
 */
- (nullable NSIndexPath *)indexPathForItem:(__kindof CPBaseListItem *)item;
...
/**
 ...
 removed.
 */
@property (nonatomic, copy) NSArray<NSString *> *emptyViewTitleVariants API_AVAILABLE(ios(14_0));
...
/**
 ...
 removed.
 */
@property (nonatomic, copy) NSArray<NSString *> *emptyViewSubtitleVariants API_AVAILABLE(ios(14_0));
 ...
 */
- (void)listTemplate:(CPListTemplate *)listTemplate didSelectListItem:(__kindof CPBaseListItem *)item completionHandler:(void (^)(void))completionHandler;
