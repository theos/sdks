...
+ (nullable NLEmbedding *)sentenceEmbeddingForLanguage:(NLLanguage)language API_AVAILABLE(macos(10.16), ios(14.0), watchos(7.0), tvos(14.0)) NS_SWIFT_NAME(sentenceEmbedding(for:));
+ (nullable NLEmbedding *)sentenceEmbeddingForLanguage:(NLLanguage)language revision:(NSUInteger)revision API_AVAILABLE(macos(10.16), ios(14.0), watchos(7.0), tvos(14.0)) NS_SWIFT_NAME(sentenceEmbedding(for:revision:));
...
+ (NSIndexSet *)supportedSentenceEmbeddingRevisionsForLanguage:(NLLanguage)language API_AVAILABLE(macos(10.16), ios(14.0), watchos(7.0), tvos(14.0)) NS_SWIFT_NAME(supportedSentenceEmbeddingRevisions(for:));
+ (NSUInteger)currentSentenceEmbeddingRevisionForLanguage:(NLLanguage)language API_AVAILABLE(macos(10.16), ios(14.0), watchos(7.0), tvos(14.0)) NS_SWIFT_NAME(currentSentenceEmbeddingRevision(for:));
