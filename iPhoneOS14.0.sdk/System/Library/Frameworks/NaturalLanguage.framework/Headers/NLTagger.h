...
*/
- (NSRange)tokenRangeForRange:(NSRange)range unit:(NLTokenUnit)unit API_AVAILABLE(macos(10.16), ios(14.0), watchos(7.0), tvos(14.0)) NS_REFINED_FOR_SWIFT;
...
- (NSDictionary<NLTag, NSNumber *> *)tagHypothesesAtIndex:(NSUInteger)characterIndex unit:(NLTokenUnit)unit scheme:(NLTagScheme)scheme maximumCount:(NSUInteger)maximumCount tokenRange:(nullable NSRangePointer)tokenRange API_AVAILABLE(macos(10.16), ios(14.0), watchos(7.0), tvos(14.0)) NS_REFINED_FOR_SWIFT;
