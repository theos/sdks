...
- (NSDictionary<NSString *, NSNumber *> *)predictedLabelHypothesesForString:(NSString *)string maximumCount:(NSUInteger)maximumCount API_AVAILABLE(macos(10.16), ios(14.0), watchos(7.0), tvos(14.0)) NS_REFINED_FOR_SWIFT;

- (NSArray<NSDictionary<NSString *, NSNumber *> *> *)predictedLabelHypothesesForTokens:(NSArray<NSString *> *)tokens maximumCount:(NSUInteger)maximumCount API_AVAILABLE(macos(10.16), ios(14.0), watchos(7.0), tvos(14.0)) NS_REFINED_FOR_SWIFT;
