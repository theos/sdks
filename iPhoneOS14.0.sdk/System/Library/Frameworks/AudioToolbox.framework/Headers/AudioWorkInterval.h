#if (defined(USE_AUDIOTOOLBOX_PUBLIC_HEADERS) && USE_AUDIOTOOLBOX_PUBLIC_HEADERS) || !__has_include(<AudioToolboxCore/AudioWorkInterval.h>)
/*!
	...
	kAudioOutputUnitProperty_OSWorkgroup. With the ObjC API (AUAudioUnit), use the osWorkgroup property.
	If an I/O unit's device assignment changes, as a side effect, its workgroup will also change.
