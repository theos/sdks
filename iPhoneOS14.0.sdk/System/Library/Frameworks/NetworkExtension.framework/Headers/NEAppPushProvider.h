 ...
 */
- (void)startWithCompletionHandler:(void (^)(NSError * __nullable error))completionHandler API_AVAILABLE(ios(14.0)) API_UNAVAILABLE(macos, watchos, tvos);
...
/*!
 * @method handleMessage:message:completionHandler:
 * @discussion This function is called by the framework when containing application wants to perform an outgoing communication.
 * @param message NSDictionary object that was passed by containing application to the framework.
 * @param completionHandler A block that must be called when the provider has completed processing this message. It takes a parameters of type NSError.
 * A non-nil error indicates a failure in processing the message.
*/
- (void)handleMessage:(NSDictionary * _Nonnull)message completionHandler:(void (^)(NSError * __nullable error))completionHandler API_AVAILABLE(ios(14.0)) API_UNAVAILABLE(macos, watchos, tvos);
