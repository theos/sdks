 ...
 */
@property (nonatomic, readonly) NSString *name API_AVAILABLE(macos(10.11), ios(9.0)) API_UNAVAILABLE(watchos, tvos);

/*!
 * @property type
 * @discussion The endpoint's Bonjour service type.
 */
@property (nonatomic, readonly) NSString *type API_AVAILABLE(macos(10.11), ios(9.0)) API_UNAVAILABLE(watchos, tvos);

/*!
 * @property domain
 * @discussion The endpoint's Bonjour service domain.
 */
@property (nonatomic, readonly) NSString *domain API_AVAILABLE(macos(10.11), ios(9.0)) API_UNAVAILABLE(watchos, tvos);
