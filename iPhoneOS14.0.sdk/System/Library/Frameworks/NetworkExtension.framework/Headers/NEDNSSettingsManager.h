...
} API_AVAILABLE(macos(10.16), ios(14.0)) API_UNAVAILABLE(watchos, tvos);

/*! @const NEDNSSettingsManagerErrorDomain The DNS settings error domain */
NEDNSSETTINGS_EXPORT NSString * const NEDNSSettingsErrorDomain API_AVAILABLE(macos(10.16), ios(14.0)) API_UNAVAILABLE(watchos, tvos);
...
NEDNSSETTINGS_EXPORT NSString * const NEDNSSettingsConfigurationDidChangeNotification API_AVAILABLE(macos(10.16), ios(14.0)) API_UNAVAILABLE(watchos, tvos);
 ...
 */
+ (NEDNSSettingsManager *)sharedManager API_AVAILABLE(macos(10.16), ios(14.0)) API_UNAVAILABLE(watchos, tvos);
 ...
 */
- (void)loadFromPreferencesWithCompletionHandler:(void (^)(NSError * __nullable error))completionHandler API_AVAILABLE(macos(10.16), ios(14.0)) API_UNAVAILABLE(watchos, tvos);
 ...
 */
- (void)removeFromPreferencesWithCompletionHandler:(void (^)(NSError * __nullable error))completionHandler API_AVAILABLE(macos(10.16), ios(14.0)) API_UNAVAILABLE(watchos, tvos);
 ...
 */
- (void)saveToPreferencesWithCompletionHandler:(void (^)(NSError * __nullable error))completionHandler API_AVAILABLE(macos(10.16), ios(14.0)) API_UNAVAILABLE(watchos, tvos);

/*!
 * @property localizedDescription
 * @discussion A string containing a description of the DNS settings.
 */
@property (copy, nullable) NSString *localizedDescription API_AVAILABLE(macos(10.16), ios(14.0)) API_UNAVAILABLE(watchos, tvos);

/*!
 * @property dnsSettings
 * @discussion An NEDNSSettings object containing the DNS resolver configuration to apply to the system.
 */
@property (strong, nullable) NEDNSSettings *dnsSettings API_AVAILABLE(macos(10.16), ios(14.0)) API_UNAVAILABLE(watchos, tvos);
 ...
 */
@property (copy, nullable) NSArray<NEOnDemandRule *> *onDemandRules API_AVAILABLE(macos(10.16), ios(14.0)) API_UNAVAILABLE(watchos, tvos);
 ...
 */
@property (readonly, getter=isEnabled) BOOL enabled API_AVAILABLE(macos(10.16), ios(14.0)) API_UNAVAILABLE(watchos, tvos);
