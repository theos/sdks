 ...
 */
@property (readonly) NEDNSProtocol dnsProtocol API_AVAILABLE(macos(10.16), ios(14.0)) API_UNAVAILABLE(watchos, tvos);
 ...
 */
@property (copy, nullable) NSString *serverName API_AVAILABLE(macos(10.16), ios(14.0)) API_UNAVAILABLE(watchos, tvos);
 ...
 */
@property (copy, nullable) NSURL *serverURL API_AVAILABLE(macos(10.16), ios(14.0)) API_UNAVAILABLE(watchos, tvos);
