 ...
 *   per-app VPN.
 */
@property (copy) NSArray<NSString *> *excludedDomains API_AVAILABLE(macos(10.16)) API_UNAVAILABLE(ios, watchos, tvos);
 ...
 */
@property (copy) NSArray<NSString *> *associatedDomains API_AVAILABLE(macos(10.16)) API_UNAVAILABLE(ios, watchos, tvos);
