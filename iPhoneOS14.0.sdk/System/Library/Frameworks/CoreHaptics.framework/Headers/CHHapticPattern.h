...
CH_EXPORT
CHHapticPatternKey CHHapticPatternKeyVersion API_AVAILABLE(ios(13.0), macos(10.16), tvos(14.0), macCatalyst(14.0)) API_UNAVAILABLE(watchos);
CH_EXPORT
CHHapticPatternKey CHHapticPatternKeyPattern API_AVAILABLE(ios(13.0), macos(10.16), tvos(14.0), macCatalyst(14.0)) API_UNAVAILABLE(watchos);
CH_EXPORT
CHHapticPatternKey CHHapticPatternKeyEvent  API_AVAILABLE(ios(13.0), macos(10.16), tvos(14.0), macCatalyst(14.0)) API_UNAVAILABLE(watchos);
CH_EXPORT
CHHapticPatternKey CHHapticPatternKeyEventType API_AVAILABLE(ios(13.0), macos(10.16), tvos(14.0), macCatalyst(14.0)) API_UNAVAILABLE(watchos);
CH_EXPORT
CHHapticPatternKey CHHapticPatternKeyTime API_AVAILABLE(ios(13.0), macos(10.16), tvos(14.0), macCatalyst(14.0)) API_UNAVAILABLE(watchos);
CH_EXPORT
CHHapticPatternKey CHHapticPatternKeyEventDuration API_AVAILABLE(ios(13.0), macos(10.16), tvos(14.0), macCatalyst(14.0)) API_UNAVAILABLE(watchos);
CH_EXPORT
CHHapticPatternKey CHHapticPatternKeyEventWaveformPath API_AVAILABLE(ios(13.0), macos(10.16), tvos(14.0), macCatalyst(14.0)) API_UNAVAILABLE(watchos);
CH_EXPORT
CHHapticPatternKey CHHapticPatternKeyEventParameters API_AVAILABLE(ios(13.0), macos(10.16), tvos(14.0), macCatalyst(14.0)) API_UNAVAILABLE(watchos);
CH_EXPORT
CHHapticPatternKey CHHapticPatternKeyParameter API_AVAILABLE(ios(13.0), macos(10.16), tvos(14.0), macCatalyst(14.0)) API_UNAVAILABLE(watchos);
CH_EXPORT
CHHapticPatternKey CHHapticPatternKeyParameterID API_AVAILABLE(ios(13.0), macos(10.16), tvos(14.0), macCatalyst(14.0)) API_UNAVAILABLE(watchos);
CH_EXPORT
CHHapticPatternKey CHHapticPatternKeyParameterValue API_AVAILABLE(ios(13.0), macos(10.16), tvos(14.0), macCatalyst(14.0)) API_UNAVAILABLE(watchos);
CH_EXPORT
CHHapticPatternKey CHHapticPatternKeyParameterCurve API_AVAILABLE(ios(13.0), macos(10.16), tvos(14.0), macCatalyst(14.0)) API_UNAVAILABLE(watchos);
CH_EXPORT
CHHapticPatternKey CHHapticPatternKeyParameterCurveControlPoints API_AVAILABLE(ios(13.0), macos(10.16), tvos(14.0), macCatalyst(14.0)) API_UNAVAILABLE(watchos);
