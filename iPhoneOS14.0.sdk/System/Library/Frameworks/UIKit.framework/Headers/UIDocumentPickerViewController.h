...
- (instancetype)initForExportingURLs:(NSArray <NSURL *> *)urls asCopy:(BOOL)asCopy NS_DESIGNATED_INITIALIZER NS_REFINED_FOR_SWIFT API_AVAILABLE(ios(14.0)) API_UNAVAILABLE(tvos);
...
- (instancetype)initForExportingURLs:(NSArray <NSURL *> *)urls NS_REFINED_FOR_SWIFT API_AVAILABLE(ios(14.0)) API_UNAVAILABLE(tvos);
