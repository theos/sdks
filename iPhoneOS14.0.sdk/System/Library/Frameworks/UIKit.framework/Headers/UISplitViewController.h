...
UIKIT_EXTERN CGFloat const UISplitViewControllerAutomaticSupplementaryFillDimension API_AVAILABLE(ios(14.0)); // Use when you want the supplementary column to cover the secondary column. Only valid for preferredSupplementaryColumnWidthFraction
