...
SR_EXTERN API_AVAILABLE(ios(13.0)) API_UNAVAILABLE(watchos, macos) API_UNAVAILABLE(tvos)
 ...
 */
- (void)sensorReader:(SRSensorReader *)reader didChangeAuthorizationStatus:(BOOL)authorized;
...
/**
 * @brief Whether or not this reader is authorized for its initialized sensor.
 */
