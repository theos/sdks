 ...
 */
@property (nonatomic, assign) CGFloat strokeStart API_AVAILABLE(ios(14.0), tvos(14.0), macos(10.16)) API_UNAVAILABLE(watchos);
@property (nonatomic, assign) CGFloat strokeEnd API_AVAILABLE(ios(14.0), tvos(14.0), macos(10.16)) API_UNAVAILABLE(watchos);
