...
typedef float MKAnnotationViewZPriority NS_TYPED_EXTENSIBLE_ENUM API_AVAILABLE(ios(14.0), macos(10.16), tvos(14.0)) API_UNAVAILABLE(watchos);
static const MKAnnotationViewZPriority MKAnnotationViewZPriorityMax API_AVAILABLE(ios(14.0), macos(10.16), tvos(14.0)) API_UNAVAILABLE(watchos) = 1000;
static const MKAnnotationViewZPriority MKAnnotationViewZPriorityDefaultSelected API_AVAILABLE(ios(14.0), macos(10.16), tvos(14.0)) API_UNAVAILABLE(watchos) = 1000;
static const MKAnnotationViewZPriority MKAnnotationViewZPriorityDefaultUnselected API_AVAILABLE(ios(14.0), macos(10.16), tvos(14.0)) API_UNAVAILABLE(watchos) = 500;
static const MKAnnotationViewZPriority MKAnnotationViewZPriorityMin API_AVAILABLE(ios(14.0), macos(10.16), tvos(14.0)) API_UNAVAILABLE(watchos) = 0;
...
typedef NS_ENUM(NSInteger, MKAnnotationViewCollisionMode) {
    ...
    MKAnnotationViewCollisionModeNone API_AVAILABLE(ios(14.0), macos(10.16), tvos(14.0)) API_UNAVAILABLE(watchos)
...
@property (nonatomic) MKAnnotationViewZPriority zPriority API_AVAILABLE(ios(14.0), macos(10.16), tvos(14.0)) API_UNAVAILABLE(watchos);
@property (nonatomic) MKAnnotationViewZPriority selectedZPriority API_AVAILABLE(ios(14.0), macos(10.16), tvos(14.0)) API_UNAVAILABLE(watchos);
