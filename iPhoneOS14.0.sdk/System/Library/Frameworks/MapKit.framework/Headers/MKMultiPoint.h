...
- (CGFloat)locationAtPointIndex:(NSUInteger)index API_AVAILABLE(ios(14.0), tvos(14.0), macos(10.16)) API_UNAVAILABLE(watchos);
- (NSArray<NSNumber *> *)locationsAtPointIndexes:(NSIndexSet *)indexes NS_REFINED_FOR_SWIFT API_AVAILABLE(ios(14.0), tvos(14.0), macos(10.16)) API_UNAVAILABLE(watchos);
