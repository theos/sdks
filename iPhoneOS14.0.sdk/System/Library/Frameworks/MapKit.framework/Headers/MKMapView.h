...
} API_AVAILABLE(ios(5.0), tvos(9.2), macos(10.16)) API_UNAVAILABLE(watchos);
...
@property (nonatomic) BOOL showsPitchControl API_AVAILABLE(macos(10.16), macCatalyst(14.0)) API_UNAVAILABLE(ios, watchos, tvos);
...
@property (nonatomic) MKUserTrackingMode userTrackingMode API_AVAILABLE(ios(5.0), tvos(9.2), macos(10.16)) API_UNAVAILABLE(watchos);
- (void)setUserTrackingMode:(MKUserTrackingMode)mode animated:(BOOL)animated API_AVAILABLE(ios(5.0), tvos(9.2), macos(10.16)) API_UNAVAILABLE(watchos);
...
- (void)mapView:(MKMapView *)mapView didChangeUserTrackingMode:(MKUserTrackingMode)mode animated:(BOOL)animated API_AVAILABLE(ios(5.0), tvos(9.2), macos(10.16)) API_UNAVAILABLE(watchos);
