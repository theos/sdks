...
/*! @abstract   Initialization for the MLCOptimizerDescriptor object
    @param      optimizerDescriptor        The optimizer descriptor
    @return     A valid MLCOptimizerDescriptor object.
 */
- (instancetype)initWithDescriptor:(MLCOptimizerDescriptor *)optimizerDescriptor;
