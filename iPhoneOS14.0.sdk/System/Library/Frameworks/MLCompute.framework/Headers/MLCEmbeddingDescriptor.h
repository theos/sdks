 ...
 *  @abstract   An unsigned int, the dimension of embedding vectors
 */
@property (readonly, nonatomic) NSNumber *embeddingDimension NS_REFINED_FOR_SWIFT;

/*! @property   paddingIndex
 *  @abstract   An unsigned int, if set, initializes the embedding vector at paddingIndex to zero, which will not be updated in gradient pass either, Default=nil
 */
