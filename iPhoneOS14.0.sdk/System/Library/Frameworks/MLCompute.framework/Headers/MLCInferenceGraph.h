...
/*! @abstract   Get the source tensors for a layer in the inference graph
    @param      layer   A layer in the inference graph
    @return     A list of tensors
 */
- (NSArray<MLCTensor *> *)sourceTensorsForLayer:(MLCLayer *)layer;

/*! @abstract   Get the result tensors for a layer in the inference graph
    @param      layer   A layer in the inference graph
    @return     A list of tensors
*/
