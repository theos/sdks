 ...
 */
@property (readwrite, nonatomic) BOOL supportIndirectCommandBuffers API_AVAILABLE(ios(13.0),macos(10.16));
 ...
 */
@property (readonly) BOOL supportIndirectCommandBuffers API_AVAILABLE(ios(13.0),macos(10.16));
