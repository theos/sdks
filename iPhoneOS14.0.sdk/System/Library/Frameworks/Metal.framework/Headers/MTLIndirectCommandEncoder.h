...
API_AVAILABLE(ios(13.0),macos(10.16))
@protocol MTLIndirectComputeCommand <NSObject>
- (void)setComputePipelineState:(id <MTLComputePipelineState>)pipelineState API_AVAILABLE(ios(13.0),macos(10.16));
...
- (void)setImageblockWidth:(NSUInteger)width height:(NSUInteger)height API_AVAILABLE(ios(14.0)) API_UNAVAILABLE(macos, macCatalyst);
