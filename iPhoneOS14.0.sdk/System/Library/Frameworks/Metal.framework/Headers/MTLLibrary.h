...
typedef NS_ENUM(NSUInteger, MTLFunctionType) {
    ...
    MTLFunctionTypeVisible API_AVAILABLE(macos(10.16), ios(14.0)) = 5,
    MTLFunctionTypeIntersection API_AVAILABLE(macos(10.16), ios(14.0)) = 6,
 ...
 */
@property (readonly) MTLFunctionOptions options API_AVAILABLE(macos(10.16), ios(14.0));
...
typedef NS_ENUM(NSUInteger, MTLLanguageVersion) {
    ...
    MTLLanguageVersion2_3 API_AVAILABLE(macos(10.16), ios(14.0)) = (2 << 16) + 3,
...
*/
@property (readwrite, nonatomic) MTLLibraryType libraryType API_AVAILABLE(macos(10.16), ios(14.0));
 ...
 */
@property (readwrite, nullable, copy, nonatomic) NSString *installName API_AVAILABLE(macos(10.16), ios(14.0));
...
*/
@property (readwrite, nullable, copy, nonatomic) NSArray<id<MTLDynamicLibrary>> *libraries API_AVAILABLE(macos(10.16), ios(14.0));
 ...
 */
@property (readwrite, nonatomic) BOOL preserveInvariance API_AVAILABLE(macos(10.16), macCatalyst(14.0), ios(13.0));
@end
...
- (void)newFunctionWithDescriptor:(nonnull MTLFunctionDescriptor *)descriptor
                completionHandler:(void (^)(id<MTLFunction> __nullable function, NSError* __nullable error))completionHandler API_AVAILABLE(macos(10.16), ios(14.0));
...
- (nullable id <MTLFunction>)newFunctionWithDescriptor:(nonnull MTLFunctionDescriptor *)descriptor
                                                 error:(__autoreleasing NSError **)error API_AVAILABLE(macos(10.16), ios(14.0));
 ...
 */
@property (readonly) MTLLibraryType type API_AVAILABLE(macos(10.16), ios(14.0));
...
/*!
 ...
 @see MTLCompileOptions
 */
@property (readonly, nullable) NSString* installName API_AVAILABLE(macos(10.16), ios(14.0));
