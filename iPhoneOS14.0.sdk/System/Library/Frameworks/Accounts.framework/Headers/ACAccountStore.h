...
ACCOUNTS_EXTERN NSString * const ACAccountStoreDidChangeNotification API_DEPRECATED("Public notification deprecated. Internal clients, see private header for replacement", ios(5.0, 14.0), macos(10.8, 10.16), tvos(5.0, 14.0), watchos(1.0, 6.0));
