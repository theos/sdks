...
/*!
  ...
  Configuration 1: Convolution -> Batchnorm+Activation
  filter0 is convolution and filter1 is batchnorm, the filter_type and layer_params arrays should be as follows:
  filter_type: [BNNSConvolution, BNNSBatchNorm]
  layer_params: [pointer to BNNSLayerParametersConvolution, pointer to BNNSLayerParametersBatchNorm]
  convolution must have activation function BNNSActivationFunctionIdentity, batchnorm can have any activation function as long as it comply with fused activation restrictions described in BNNSFilterApplyBackwardBatch

  Configuration 2: FullyConnected -> Batchnorm+Activation
  filter0 is fully connected and filter1 is batchnorm, the filter_type and layer_params arrays should be as follows:
  filter_type: [BNNSFullyConnected, BNNSBatchNorm]
  layer_params: [pointer to BNNSLayerParametersFullyConnected, pointer to BNNSLayerParametersBatchNorm]
  fully connected must have activation function BNNSActivationFunctionIdentity, batchnorm can have any activation function as long as it comply with fused activation restrictions described in BNNSFilterApplyBackwardBatch
...
BNNSFilter BNNSFilterCreateConvolutionLayer(const BNNSImageStackDescriptor * in_desc,
                                            ...
                                            const BNNSFilterParameters * _Nullable filter_params)
__API_DEPRECATED_WITH_REPLACEMENT("BNNSFilterCreateLayerConvolution", macos(10.12, 10.16), ios(10.0, 14.0), watchos(3.0, 7.0), tvos(10.0, 14.0));
...
BNNSFilter BNNSFilterCreateFullyConnectedLayer(const BNNSVectorDescriptor * in_desc,
                                               ...
                                               const BNNSFilterParameters * _Nullable filter_params)
__API_DEPRECATED_WITH_REPLACEMENT("BNNSFilterCreateLayerFullyConnected", macos(10.12, 10.16), ios(10.0, 14.0), watchos(3.0, 7.0), tvos(10.0, 14.0));
...
BNNSFilter BNNSFilterCreatePoolingLayer(const BNNSImageStackDescriptor * in_desc,
                                        ...
                                        const BNNSFilterParameters * _Nullable filter_params)
__API_DEPRECATED_WITH_REPLACEMENT("BNNSFilterCreateLayerPooling", macos(10.12, 10.16), ios(10.0, 14.0), watchos(3.0, 7.0), tvos(10.0, 14.0));
...
BNNSFilter BNNSFilterCreateVectorActivationLayer(const BNNSVectorDescriptor * in_desc,
                                                 ...
                                                 const BNNSFilterParameters * _Nullable filter_params)
__API_DEPRECATED_WITH_REPLACEMENT("BNNSFilterCreateLayerActivation", macos(10.13, 10.16), ios(11.0, 14.0), watchos(4.0, 7.0), tvos(11.0, 14.0));
