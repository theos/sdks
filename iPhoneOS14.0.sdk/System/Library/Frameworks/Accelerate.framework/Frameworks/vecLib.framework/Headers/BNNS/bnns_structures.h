...
__API_DEPRECATED("BNNS switched to new Layer Parameters data structures",macos(10.12, 10.16), ios(10.0, 14.0), watchos(3.0, 7.0), tvos(10.0, 14.0));
...
*/
typedef struct __API_DEPRECATED_WITH_REPLACEMENT("BNNSLayerParametersConvolution", macos(10.12, 10.16), ios(10.0, 14.0), watchos(3.0, 7.0), tvos(10.0, 14.0)) {
...
__API_DEPRECATED_WITH_REPLACEMENT("BNNSLayerParametersConvolution", macos(10.12, 10.16), ios(10.0, 14.0), watchos(3.0, 7.0), tvos(10.0, 14.0));
...
*/
typedef struct __API_DEPRECATED_WITH_REPLACEMENT("BNNSLayerParametersFullyConnected", macos(10.12, 10.16), ios(10.0, 14.0), watchos(3.0, 7.0), tvos(10.0, 14.0)) {
  size_t in_size;
  size_t out_size;
...
__API_DEPRECATED_WITH_REPLACEMENT("BNNSLayerParametersFullyConnected", macos(10.12, 10.16), ios(10.0, 14.0), watchos(3.0, 7.0), tvos(10.0, 14.0));
...
typedef struct __API_DEPRECATED_WITH_REPLACEMENT("BNNSLayerParametersPooling", macos(10.12, 10.16), ios(10.0, 14.0), watchos(3.0, 7.0), tvos(10.0, 14.0)) {
  size_t x_stride;
  size_t y_stride;
  size_t x_padding;
  size_t y_padding;
...
__API_DEPRECATED_WITH_REPLACEMENT("BNNSLayerParametersPooling", macos(10.12, 10.16), ios(10.0, 14.0), watchos(3.0, 7.0), tvos(10.0, 14.0));
