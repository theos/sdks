...
} __API_AVAILABLE(ios(10.0)) __API_UNAVAILABLE(macCatalyst, macos) __API_UNAVAILABLE(tvos, watchos);
...
@property (nonatomic, copy) NSArray <UNNotificationAction *> *notificationActions __API_AVAILABLE(ios(12.0), macCatalyst(10.16), macos(10.16)) __API_UNAVAILABLE(tvos, watchos);

// Opens the corresponding applicaton and delivers it the default notification action response
- (void)performNotificationDefaultAction __API_AVAILABLE(ios(12.0), macCatalyst(10.16), macos(10.16)) __API_UNAVAILABLE(tvos, watchos);

- (void)dismissNotificationContentExtension __API_AVAILABLE(ios(12.0), macCatalyst(10.16), macos(10.16)) __API_UNAVAILABLE(tvos, watchos);
...
- (void)mediaPlayingStarted __API_AVAILABLE(ios(10.0), macCatalyst(10.16), macos(10.16)) __API_UNAVAILABLE(tvos, watchos);
- (void)mediaPlayingPaused __API_AVAILABLE(ios(10.0), macCatalyst(10.16), macos(10.16)) __API_UNAVAILABLE(tvos, watchos);
