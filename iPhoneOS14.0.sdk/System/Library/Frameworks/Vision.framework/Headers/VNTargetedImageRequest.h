...
/*!
    ...
    @param sampleBuffer            The CMSampleBuffer of which the imagebuffer will be used.
    @param    options                A dictionary with options specifying auxiliary information for the image.
*/
- (instancetype) initWithTargetedCMSampleBuffer:(CMSampleBufferRef)sampleBuffer options:(NSDictionary<VNImageOption, id> *)options;
...
/*!
    ...
    @param    completionHandler    The block that is invoked when the request has been performed.
*/
- (instancetype) initWithTargetedCMSampleBuffer:(CMSampleBufferRef)sampleBuffer options:(NSDictionary<VNImageOption, id> *)options completionHandler:(nullable VNRequestCompletionHandler)completionHandler;
...
/*!
    ...
    @param    options                A dictionary with options specifying auxiliary information for the image.
*/
- (instancetype) initWithTargetedCMSampleBuffer:(CMSampleBufferRef)sampleBuffer orientation:(CGImagePropertyOrientation)orientation options:(NSDictionary<VNImageOption, id> *)options;
...
/*!
    ...
    @param    completionHandler    The block that is invoked when the request has been performed.
*/
- (instancetype) initWithTargetedCMSampleBuffer:(CMSampleBufferRef)sampleBuffer orientation:(CGImagePropertyOrientation)orientation options:(NSDictionary<VNImageOption, id> *)options completionHandler:(nullable VNRequestCompletionHandler)completionHandler;
