 ...
 */
@property (readonly, nonatomic, assign) CMTimeRange timeRange API_AVAILABLE(macos(10.16), ios(14.0), tvos(14.0));
...
/*!
 @brief An observation that provides all the detected contours in an image
 */
API_AVAILABLE(macos(10.16), ios(14.0), tvos(14.0))
...
/*!
 ...
 @details This value can be used to determine the number of indices available for calling contourAtIndex.
 */
@property (readonly) NSUInteger contourCount;

/*!
 @brief Returns the VNContour object at the specified index, irrespective of hierarchy.
 @param contourIndex The index of the contour to request. Valid values are in the range of 0 to the value of the contourCount property minus 1, [0 ... contourCount-1].
 ...
 */
- (nullable VNContour *) contourAtIndex:(NSUInteger)contourIndex error:(NSError **)error;
...
/*!
 @brief All the contours represented as a CGPath in normalized coordinates.
...
/*!
 ...
 @discussion Is the result of requests that detect points of interest like VNDetectHumanBodyPoseRequest or VNDetectHumanHandPoseRequest.
 
 */
API_AVAILABLE(macos(10.16), ios(14.0), tvos(14.0))
@interface VNRecognizedPointsObservation : VNObservation

VN_EXPORT VNRecognizedPointGroupKey const VNRecognizedPointGroupKeyAll;
...
/*!
 @brief The availableGroupKeys property retruns all of the point group labels usable with the observation
 */
@property (readonly) NSArray<VNRecognizedPointGroupKey>* availableGroupKeys;


/*!
@brief    Obtains the grouping of normalized recognized points.
 
@discussion A dictionary that maps a landmark region key name to the corresponding VNIdentifiedPoint, which represents the normalized landmark point and its confidence.

@return the dictionary of key-region points.
*/
...
/*!
@brief    Returns the grouping of normalized point coordinates and confidences in an MLMultiArray format.
 
@discussion A MLMultiArray that contains the raw data output of the returned points in the form (x coordinate, y coordinate, confidence) in the format expected by CreateML action recognition models.
            The datatype of the elements in the array is double and the dimensions are [1, 3, # of possible points].  If a point expected is not found, the MLMultiArray will be populated with 0s

@return the MLMultiArray representation of key-region points.
*/
...
API_DEPRECATED_WITH_REPLACEMENT("Use VNRecognizedPointsObservation instead", macos(10.16, 10.16), ios(14.0, 14.0), tvos(14.0, 14.0))
@interface VNIdentifiedPointsObservation : VNRecognizedPointsObservation

- (nullable NSDictionary<VNRecognizedPointKey, VNRecognizedPoint*>*) identifiedPointsForGroupKey:(VNRecognizedPointGroupKey)groupKey error:(NSError**)error
				API_DEPRECATED_WITH_REPLACEMENT("Use -[VNRecognizedPointsObservation recognizedPointsForGroupKey:error:] instead", macos(10.16, 10.16), ios(14.0, 14.0), tvos(14.0, 14.0));
@end
