...
CM_EXPORT const CFStringRef kCMFormatDescriptionConformsToMPEG2VideoProfile			// CFNumber specifying a kCMMPEG2VideoProfile_*
							API_AVAILABLE(macos(10.7), ios(4.0), tvos(9.0), watchos(6.0));
CM_EXPORT const CFStringRef kCMFormatDescriptionExtension_ProtectedContentOriginalFormat API_AVAILABLE(macos(10.16), ios(14.0), tvos(14.0), watchos(7.0)); // CNNumberRef as FourCharCode
