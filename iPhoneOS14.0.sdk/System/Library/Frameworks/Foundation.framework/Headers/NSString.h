...
typedef NS_OPTIONS(NSUInteger, NSStringEnumerationOptions) {
    ...
    NSStringEnumerationByCaretPositions API_AVAILABLE(macos(10.16), ios(14.0), watchos(7.0), tvos(14.0)) = 5, // Enumerate text editing cursor positions. It could separate characters within a grapheme cluster.
    NSStringEnumerationByDeletionClusters API_AVAILABLE(macos(10.16), ios(14.0), watchos(7.0), tvos(14.0)) = 6, //  Enumerate text editing positions for backwards deletion. It could separate characters within a grapheme cluster.
