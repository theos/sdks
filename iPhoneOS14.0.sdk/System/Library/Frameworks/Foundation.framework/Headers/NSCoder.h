 ...
 */
- (nullable NSArray *)decodeArrayOfObjectsOfClass:(Class)cls forKey:(NSString *)key API_AVAILABLE(macos(10.16), ios(14.0), watchos(7.0), tvos(14.0)) NS_REFINED_FOR_SWIFT;
...
/**
 ...
 Returns \c nil if the object for \c key is not of the expected types, or cannot be decoded, and sets the \c error on the decoder.
 */
- (nullable NSDictionary *)decodeDictionaryWithKeysOfClass:(Class)keyCls objectsOfClass:(Class)objectCls forKey:(NSString *)key API_AVAILABLE(macos(10.16), ios(14.0), watchos(7.0), tvos(14.0)) NS_REFINED_FOR_SWIFT;
...
/**
 ...
 Returns \c nil if the object for \c key is not of the expected types, or cannot be decoded, and sets the \c error on the decoder.
 */
- (nullable NSArray *)decodeArrayOfObjectsOfClasses:(NSSet<Class> *)classes forKey:(NSString *)key API_AVAILABLE(macos(10.16), ios(14.0), watchos(7.0), tvos(14.0)) NS_REFINED_FOR_SWIFT;
...
/**
 ...
 Returns \c nil if the object for \c key is not of the expected types, or cannot be decoded, and sets the \c error on the decoder.
 */
- (nullable NSDictionary *)decodeDictionaryWithKeysOfClasses:(NSSet<Class> *)keyClasses objectsOfClasses:(NSSet<Class> *)objectClasses forKey:(NSString *)key API_AVAILABLE(macos(10.16), ios(14.0), watchos(7.0), tvos(14.0)) NS_REFINED_FOR_SWIFT;
