...
/*!
 ...
 @discussion Returns the network information for the specified interface when the requesting application meets one of following 3 requirements -.
	...
	- On Mac Catalyst platform, to receive BSSID of the current Wi-Fi network, an application must have "com.apple.developer.networking.wifi-info"
...
API_AVAILABLE(ios(4.1), watchos(7.0), macCatalyst(14.0))
