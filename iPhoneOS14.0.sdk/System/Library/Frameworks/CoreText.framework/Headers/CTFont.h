...
ATSFontRef CTFontGetPlatformFont(
    CTFontRef               font,
    CTFontDescriptorRef _Nullable * _Nullable attributes ) CT_DEPRECATED("ATS is deprecated", macos(10.5, 10.16)) CT_UNAVAILABLE(ios, watchos, tvos);
...
CTFontRef _Nullable CTFontCreateWithPlatformFont(
    ...
    CGFloat                     size,
    const CGAffineTransform * _Nullable matrix,
    CTFontDescriptorRef _Nullable attributes ) CT_DEPRECATED("ATS is deprecated", macos(10.5, 10.16)) CT_UNAVAILABLE(ios, watchos, tvos);
