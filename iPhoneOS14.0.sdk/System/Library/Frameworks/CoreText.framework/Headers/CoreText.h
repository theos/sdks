...
uint32_t CTGetCoreTextVersion( void ) CT_DEPRECATED("Use -[NSProcessInfo operatingSystemVersion]", macos(10.5, 10.16), ios(3.2, 14.0), watchos(2.0, 7.0), tvos(9.0, 14.0));
...
#define kCTVersionNumber10_16 0x000D0000
