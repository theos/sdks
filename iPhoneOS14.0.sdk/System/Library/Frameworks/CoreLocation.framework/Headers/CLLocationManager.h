 ...
 */
- (CLAuthorizationStatus)authorizationStatus API_AVAILABLE(ios(14.0), macos(10.16), watchos(7.0), tvos(14.0));
 ...
 */
+ (CLAuthorizationStatus)authorizationStatus API_DEPRECATED_WITH_REPLACEMENT("-authorizationStatus", ios(4.2, 14.0), macos(10.7, 10.16), watchos(1.0, 7.0), tvos(9.0, 14.0));

@property (nonatomic, readonly, getter=isAuthorizedForPreciseLocation) BOOL authorizedForPreciseLocation API_DEPRECATED_WITH_REPLACEMENT("-accuracyAuthorization", ios(14.0, 14.0), macos(10.16, 10.16), watchos(7.0, 7.0), tvos(14.0, 14.0));
 ...
 *      CLAccuracyAuthorizationFullAccuracy.
 */
@property (nonatomic, readonly) CLAccuracyAuthorization accuracyAuthorization API_AVAILABLE(ios(14.0), macos(10.16), watchos(7.0), tvos(14.0));
 ...
 */
@property(copy, nonatomic, nullable) NSString *purpose API_DEPRECATED("Set the purpose string in Info.plist using key NSLocationUsageDescription", ios(3.2, 6.0), macos(10.7, 10.16)) API_UNAVAILABLE(watchos, tvos);
 ...
 */
- (void)requestTemporaryFullAccuracyAuthorizationWithPurposeKey:(NSString *)purposeKey completion:(void(^ _Nullable)(NSError * _Nullable))completion API_AVAILABLE(ios(14.0), macos(10.16), watchos(7.0), tvos(14.0));
 ...
 *      completion block.
 */
- (void)requestTemporaryFullAccuracyAuthorizationWithPurposeKey:(NSString *)purposeKey API_AVAILABLE(ios(14.0), macos(10.16), watchos(7.0), tvos(14.0));

- (void)requestTemporaryPreciseLocationAuthorizationWithPurposeKey:(NSString *)purposeKey completion:(void(^ _Nullable)(NSError * _Nullable))completion API_DEPRECATED_WITH_REPLACEMENT("-requestTemporaryAccurateLocationAuthorizationWithPurposeKey:completion:", ios(14.0, 14.0), macos(10.16, 10.16), watchos(7.0, 7.0), tvos(14.0, 14.0));
- (void)requestTemporaryPreciseLocationAuthorizationWithPurposeKey:(NSString *)purposeKey API_DEPRECATED_WITH_REPLACEMENT("-requestTemporaryAccurateLocationAuthorizationWithPurposeKey:", ios(14.0, 14.0), macos(10.16, 10.16), watchos(7.0, 7.0), tvos(14.0, 14.0));
