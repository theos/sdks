...
/*!
	...
	@field			words
                        ...
                        (This is declared to be 256 bytes in length so clients don't have to
...
/*!
	...
	@constant	kMIDIMsgSerialPortOwnerChanged	No data.  New in Mac OS X 10.2.
...
/*!
	...
	@discussion
		...
		this property.
*/
extern const CFStringRef	kMIDIPropertyProtocolID					API_AVAILABLE(macos(10.16), ios(14.0), tvos(14.0));
...
MIDIInputPortCreateWithProtocol(MIDIClientRef	client,
								...
								MIDIProtocolID	protocol,
								MIDIPortRef *	outPort,
								MIDIReceiveBlock receiveBlock )	API_AVAILABLE(macos(10.16), ios(14.0), tvos(14.0));
...
MIDIDestinationCreateWithProtocol(	MIDIClientRef 	client,
									...
									MIDIReceiveBlock	readBlock ) API_AVAILABLE(macos(10.16), ios(14.0), tvos(14.0));
...
MIDISourceCreateWithProtocol(	MIDIClientRef 		client,
								CFStringRef  		name,
								MIDIProtocolID		protocol,
								MIDIEndpointRef * 	outSrc ) API_AVAILABLE(macos(10.16), ios(14.0), tvos(14.0));
...
MIDISendEventList(	MIDIPortRef 				port,
					...
					const MIDIEventList *		evtlist )	API_AVAILABLE(macos(10.16), ios(14.0), tvos(14.0));
...
MIDIEventListInit(	MIDIEventList *evtlist,
					MIDIProtocolID protocol)			API_AVAILABLE(macos(10.16), ios(14.0), tvos(14.0));
...
MIDIEventListAdd(	MIDIEventList *		evtlist,
					...
					MIDITimeStamp		time,
					ByteCount			wordCount,
					const UInt32 *		words)			API_AVAILABLE(macos(10.16), ios(14.0), tvos(14.0));
