...
#define MIDICI1_1_AVAILABILITY API_AVAILABLE(macos(10.16), ios(14.0)) API_UNAVAILABLE(watchos, tvos)
...
/*!
	...
	@property	manufacturerID
					The MIDI System Exclusive ID of the device manufacturer, 3 bytes long. One-byte SysEx IDs are padded with trailing
					zeroes (e.g., Apple's System Exclusive ID, 0x11, would be expressed as 0x110000).
