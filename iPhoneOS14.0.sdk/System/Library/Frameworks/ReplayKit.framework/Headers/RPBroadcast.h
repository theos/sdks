...
*/
+ (void)showBroadcastPickerAtPoint:(CGPoint)point fromWindow:(NSWindow *_Nullable)window preferredExtensionIdentifier:(NSString *_Nullable)preferredExtension completionHandler:(void (^)(RPBroadcastActivityController *_Nullable broadcastActivityController, NSError *_Nullable error))handler API_AVAILABLE(macos(10.16));
 ...
 */
- (void)broadcastActivityController:(RPBroadcastActivityController *)broadcastActivityController didFinishWithBroadcastController:(nullable RPBroadcastController *)broadcastController error:(nullable NSError *)error API_AVAILABLE(macos(10.16));
@end
#endif
 ...
 */
API_AVAILABLE(ios(10.0), tvos(10.0), macCatalyst(10.15))
 ...
 */
API_AVAILABLE(ios(12.0),macCatalyst(10.15)) API_UNAVAILABLE(tvos, macos)
