 ...
 */
- (void)loadBroadcastingApplicationInfoWithCompletion:(void (^)(NSString *bundleID, NSString *displayName, NSImage *__nullable appIcon))handler API_AVAILABLE(macos(10.16)) API_UNAVAILABLE(ios, tvos, macCatalyst);
#else
/*! @abstract Load information about the broadcasting app.
    @param handler block which will be supplied a bundleID, displayName and an optional appIcon.
 */
...
- (void)completeRequestWithBroadcastURL:(NSURL *)broadcastURL setupInfo:(nullable NSDictionary <NSString *, NSObject <NSCoding> *> *)setupInfo API_AVAILABLE(ios(11.0), tvos(11.0), macCatalyst(10.15), macos(10.16));
 ...
 */
API_AVAILABLE(ios(10.0), tvos(10.0), macCatalyst(10.15), macos(10.16))
 ...
 */
- (void)updateBroadcastURL:(NSURL *)broadcastURL API_AVAILABLE(ios(11.0), tvos(11.0), macCatalyst(10.15), macos(10.16));
@end
 ...
 */
API_DEPRECATED("No longer supported, use RPBroadcastSampleHandler instead.", ios(10.0, 11.0), tvos(10.0, 11.0), macCatalyst(10.15, 10.15)) API_UNAVAILABLE(macos)
 ...
 */
API_AVAILABLE(ios(11.0), tvos(11.0), macCatalyst(10.15), macos(10.16))
 ...
 */
API_AVAILABLE(ios(11.2), macCatalyst(10.15), macos(10.16)) API_UNAVAILABLE(tvos)
