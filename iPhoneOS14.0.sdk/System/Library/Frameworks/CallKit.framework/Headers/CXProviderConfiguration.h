...
CX_EXTERN API_AVAILABLE(ios(10.0), macCatalyst(13.0), macos(10.16))  API_UNAVAILABLE(watchos, tvos)
@interface CXProviderConfiguration : NSObject <NSCopying>

/// Localized name of the provider
@property (nonatomic, readonly, copy, nullable) NSString *localizedName API_DEPRECATED("No longer supported", ios(10.0, 14.0), macCatalyst(13.0, 14.0), macos(10.16, 10.16)) API_UNAVAILABLE(tvos, watchos);
...
/// Default: YES
@property (nonatomic) BOOL includesCallsInRecents API_AVAILABLE(ios(11.0), macCatalyst(13.0), macos(10.16)) API_UNAVAILABLE(watchos);
...
- (instancetype)init NS_DESIGNATED_INITIALIZER API_AVAILABLE(ios(14.0), macCatalyst(14.0), macos(10.16))  API_UNAVAILABLE(watchos, tvos);
