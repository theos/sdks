...
CX_EXTERN NSErrorDomain const CXErrorDomain API_AVAILABLE(ios(10.0), macCatalyst(13.0), macos(10.16))  API_UNAVAILABLE(watchos, tvos);
CX_EXTERN NSErrorDomain const CXErrorDomainIncomingCall API_AVAILABLE(ios(10.0), macCatalyst(13.0), macos(10.16))  API_UNAVAILABLE(watchos, tvos);
CX_EXTERN NSErrorDomain const CXErrorDomainRequestTransaction API_AVAILABLE(ios(10.0), macCatalyst(13.0), macos(10.16))  API_UNAVAILABLE(watchos, tvos);
CX_EXTERN NSErrorDomain const CXErrorDomainCallDirectoryManager API_AVAILABLE(ios(10.0), macCatalyst(13.0), macos(10.16))  API_UNAVAILABLE(watchos, tvos);
...
} API_AVAILABLE(ios(10.0), macCatalyst(13.0), macos(10.16))  API_UNAVAILABLE(watchos, tvos);
