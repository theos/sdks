 ...
 */
- (instancetype)initWithContentType:(UTType *)outputContentType NS_DESIGNATED_INITIALIZER API_AVAILABLE(macos(10.16), ios(14.0), tvos(14.0)) API_UNAVAILABLE(watchos);
...
/*!
 ...
 @discussion
	...
	This property cannot be set after writing has started.
 */
@property (nonatomic) NSInteger initialMovieFragmentSequenceNumber API_AVAILABLE(macos(10.16), ios(14.0), tvos(14.0)) API_UNAVAILABLE(watchos);
...
/*!
 ...
 @discussion
	...
	This property cannot be set after writing has started.
 */
@property (nonatomic) BOOL producesCombinableFragments API_AVAILABLE(macos(10.16), ios(14.0), tvos(14.0)) API_UNAVAILABLE(watchos);
...
/*!
 ...
 @discussion
	...
	This property cannot be set after writing has started.
 */
@property (nonatomic) CMTime preferredOutputSegmentInterval API_AVAILABLE(macos(10.16), ios(14.0), tvos(14.0)) API_UNAVAILABLE(watchos);
...
/*!
 ...
 @discussion
	...
	This property cannot be set after writing has started.
 */
@property (nonatomic) CMTime initialSegmentStartTime API_AVAILABLE(macos(10.16), ios(14.0), tvos(14.0)) API_UNAVAILABLE(watchos);
...
@property (nonatomic, copy, nullable) AVFileTypeProfile outputFileTypeProfile API_AVAILABLE(macos(10.16), ios(14.0), tvos(14.0)) API_UNAVAILABLE(watchos);
...
/*!
 ...
 @discussion
	This property cannot be set after writing has started.
 */
@property (weak, nullable) id <AVAssetWriterDelegate> delegate API_AVAILABLE(macos(10.16), ios(14.0), tvos(14.0)) API_UNAVAILABLE(watchos);
 ...
 */
- (void)flushSegment API_AVAILABLE(macos(10.16), ios(14.0), tvos(14.0)) API_UNAVAILABLE(watchos);

@end

API_AVAILABLE(macos(10.16), ios(14.0), tvos(14.0)) API_UNAVAILABLE(watchos)
