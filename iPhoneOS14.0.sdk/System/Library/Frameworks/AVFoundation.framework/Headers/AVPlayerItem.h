 ...
 */
@property (nonatomic, assign) AVAudioSpatializationFormats allowedAudioSpatializationFormats API_AVAILABLE(macos(10.16), ios(14.0)) API_UNAVAILABLE(tvos, watchos);
 ...
 */
@property (nonatomic) BOOL startsOnFirstEligibleVariant API_AVAILABLE(macos(10.16), ios(14.0), tvos(14.0), watchos(7.0));
