...
AVF_EXPORT NSNotificationName const AVSampleBufferDisplayLayerRequiresFlushToResumeDecodingDidChangeNotification API_AVAILABLE(macos(10.16), ios(14.0), tvos(14.0)) API_UNAVAILABLE(watchos); // see requiresFlushToResumeDecoding property
...
*/
@property (nonatomic, readonly) BOOL requiresFlushToResumeDecoding API_AVAILABLE(macos(10.16), ios(14.0), tvos(14.0)) API_UNAVAILABLE(watchos);
