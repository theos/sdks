...
typedef NS_ERROR_ENUM(AVFoundationErrorDomain, AVError) {
	...
	AVErrorIncorrectlyConfigured API_AVAILABLE(macos(10.16), ios(14.0), tvos(14.0), watchos(7.0)) = -11875,
	AVErrorSegmentStartedWithNonSyncSample API_AVAILABLE(macos(10.16), ios(14.0), tvos(14.0), watchos(7.0)) = -11876,
};
