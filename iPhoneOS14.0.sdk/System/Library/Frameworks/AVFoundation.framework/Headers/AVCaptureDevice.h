...
/*!
 ...
 @param position
    The position supported by the returned device. Pass AVCaptureDevicePositionUnspecified to consider devices with any position. On Mac Catalyst, position is an optional argument where if no device is found with the provided position, then a device of any position is returned.
 @result
...
/*!
 ...
 @param position
    The position to include in the list of discovered devices. Pass AVCaptureDevicePositionUnspecified to search for devices with any position. On Mac Catalyst, position is an optional argument where if no devices are found with the provided position, then devices of any position are included.
 @result
