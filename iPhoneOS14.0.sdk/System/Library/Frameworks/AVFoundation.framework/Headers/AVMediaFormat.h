 ...
 */
AVF_EXPORT AVMediaCharacteristic const AVMediaCharacteristicContainsHDRVideo API_AVAILABLE(macos(10.16), ios(14.0), tvos(14.0)) API_UNAVAILABLE(watchos);
 ...
 */
AVF_EXPORT AVFileTypeProfile const AVFileTypeProfileMPEG4AppleHLS API_AVAILABLE(macos(10.16), ios(14.0), tvos(14.0), watchos(7.0));
 ...
 */
AVF_EXPORT AVFileTypeProfile const AVFileTypeProfileMPEG4CMAFCompliant API_AVAILABLE(macos(10.16), ios(14.0), tvos(14.0), watchos(7.0));
