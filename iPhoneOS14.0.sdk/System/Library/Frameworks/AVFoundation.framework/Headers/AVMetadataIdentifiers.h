...
AVF_EXPORT AVMetadataIdentifier const AVMetadataCommonIdentifierAccessibilityDescription                   API_AVAILABLE(macos(10.16), ios(14.0), tvos(14.0), watchos(7.0));
...
AVF_EXPORT AVMetadataIdentifier const AVMetadataIdentifierQuickTimeUserDataAccessibilityDescription        API_AVAILABLE(macos(10.16), ios(14.0), tvos(14.0), watchos(7.0));
...
AVF_EXPORT AVMetadataIdentifier const AVMetadataIdentifierISOUserDataAccessibilityDescription              API_AVAILABLE(macos(10.16), ios(14.0), tvos(14.0), watchos(7.0));
...
AVF_EXPORT AVMetadataIdentifier const AVMetadataIdentifierQuickTimeMetadataAccessibilityDescription        API_AVAILABLE(macos(10.16), ios(14.0), tvos(14.0), watchos(7.0));
...
*/
AVF_EXPORT AVMetadataIdentifier const AVMetadataIdentifierQuickTimeMetadataLocationHorizontalAccuracyInMeters API_AVAILABLE(macos(10.16), ios(14.0), tvos(14.0), watchos(7.0));
