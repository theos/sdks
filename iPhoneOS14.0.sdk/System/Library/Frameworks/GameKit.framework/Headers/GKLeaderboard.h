...
@property (strong, readonly, nonatomic) NSString *baseLeaderboardID API_AVAILABLE(ios(14.0), macos(10.16), tvos(14.0), watchos(7.0));

/// Type of leaderboard
@property (readonly, nonatomic) GKLeaderboardType type API_AVAILABLE(ios(14.0), macos(10.16), tvos(14.0), watchos(7.0));

/// Date and time this instance started accepting score submissions (only applicable to recurring leaderboards)
@property (strong, readonly, nonatomic, nullable) NSDate *startDate API_AVAILABLE(ios(14.0), macos(10.16), tvos(14.0), watchos(7.0));

/// Date and time the next instance will start accepting score submissions (only applicable to recurring leaderboards)
@property (strong, readonly, nonatomic, nullable) NSDate *nextStartDate API_AVAILABLE(ios(14.0), macos(10.16), tvos(14.0), watchos(7.0));
...
@property (readonly, nonatomic) NSTimeInterval duration API_AVAILABLE(ios(14.0), macos(10.16), tvos(14.0), watchos(7.0));
...
+ (void)loadLeaderboardsWithIDs:(NSArray<NSString *> * _Nullable)leaderboardIDs
              completionHandler:(void(^)(NSArray<GKLeaderboard *> * _Nullable leaderboards, NSError * _Nullable error))completionHandler NS_SWIFT_NAME(loadLeaderboards(IDs:completionHandler:)) API_AVAILABLE(ios(14.0), macos(10.16), tvos(14.0), watchos(7.0));
...
- (void)loadPreviousOccurrenceWithCompletionHandler:(void(^)(GKLeaderboard * _Nullable leaderboard, NSError * _Nullable error))completionHandler API_AVAILABLE(ios(14.0), macos(10.16), tvos(14.0), watchos(7.0));
...
+ (void)submitScore:(NSInteger)score
  ...
  completionHandler:(void(^)(NSError * _Nullable error))completionHandler API_AVAILABLE(ios(14.0), macos(10.16), tvos(14.0), watchos(7.0));
...
- (void)loadEntriesForPlayerScope:(GKLeaderboardPlayerScope)playerScope
                        timeScope:(GKLeaderboardTimeScope)timeScope
                            range:(NSRange)range
                completionHandler:(void(^)(GKLeaderboardEntry * _Nullable localPlayerEntry, NSArray<GKLeaderboardEntry *> * _Nullable entries, NSInteger totalPlayerCount, NSError * _Nullable error))completionHandler API_AVAILABLE(ios(14.0), macos(10.16), tvos(14.0), watchos(7.0));
...
- (void)loadEntriesForPlayers:(NSArray<GKPlayer *> *)players
                    timeScope:(GKLeaderboardTimeScope)timeScope
            completionHandler:(void(^)(GKLeaderboardEntry * _Nullable localPlayerEntry, NSArray<GKLeaderboardEntry *> * _Nullable entries, NSError * _Nullable error))completionHandler API_AVAILABLE(ios(14.0), macos(10.16), tvos(14.0), watchos(7.0));
...
@property(assign, NS_NONATOMIC_IOSONLY) GKLeaderboardTimeScope timeScope API_DEPRECATED("Use loadEntriesForPlayerScope:timeScope:range:completionHandler: instead.", ios(4.0, 14.0), tvos(9.0, 14.0), macosx(10.8, 10.16), watchos(3.0, 7.0));

/// Filter on friends. Does not apply to leaderboard initialized with players.
@property(assign, NS_NONATOMIC_IOSONLY) GKLeaderboardPlayerScope playerScope API_DEPRECATED("Use loadEntriesForPlayerScope:timeScope:range:completionHandler: instead.", ios(4.0, 14.0), tvos(9.0, 14.0), macosx(10.8, 10.16), watchos(3.0, 7.0));

/// leaderboardID. If nil, fetch the aggregate leaderboard.
@property(copy, nullable, NS_NONATOMIC_IOSONLY) NSString *identifier API_DEPRECATED("Use loadEntriesForPlayerScope:timeScope:range:completionHandler: instead.", ios(7.0, 14.0), tvos(9.0, 14.0), macosx(10.10, 10.16), watchos(2.0, 7.0));
...
@property(assign, NS_NONATOMIC_IOSONLY) NSRange range API_DEPRECATED("Use loadEntriesForPlayerScope:timeScope:range:completionHandler: instead.", ios(4.0, 14.0), tvos(9.0, 14.0), macosx(10.8, 10.16), watchos(3.0, 7.0));

/// Scores are not valid until loadScores: has completed.
@property(readonly, strong, nullable, NS_NONATOMIC_IOSONLY) NSArray<GKScore *> *scores API_DEPRECATED("Use loadEntriesForPlayerScope:timeScope:range:completionHandler: to obtain scores.", ios(4.0, 14.0), tvos(9.0, 14.0), macosx(10.8, 10.16), watchos(3.0, 7.0));

/// The maxRange which represents the size of the leaderboard is not valid until loadScores: has completed.
@property(readonly, assign, NS_NONATOMIC_IOSONLY) NSUInteger maxRange API_DEPRECATED("Use loadEntriesForPlayerScope:timeScope:range:completionHandler: method to obtain the size of the leaderboard.", ios(4.0, 14.0), tvos(9.0, 14.0), macosx(10.8, 10.16), watchos(3.0, 7.0));

/// The local player's score
@property(readonly, strong, nullable, NS_NONATOMIC_IOSONLY) GKScore *localPlayerScore API_DEPRECATED("Use loadEntriesForPlayerScope:timeScope:range:completionHandler: method to obtain scores.", ios(4.0, 14.0), tvos(9.0, 14.0), macosx(10.8, 10.16), watchos(3.0, 7.0));

/// This property is true if the leaderboard is currently loading
@property(readonly, getter=isLoading) BOOL loading API_DEPRECATED("Use loadEntriesForPlayerScope:timeScope:range:completionHandler: method to obtain scores.", ios(4.1, 14.0), tvos(9.0, 14.0), macosx(10.8, 10.16), watchos(3.0, 7.0));
...
- (instancetype)init API_DEPRECATED("Do not instantiate GKLeaderboard directly. Use class method loadLeaderboardsWithIDs:completionHandler: to get the leaderboards.", ios(4.0, 14.0), tvos(9.0, 14.0), macosx(10.8, 10.16), watchos(3.0, 7.0));
...
- (instancetype)initWithPlayers:(NSArray<GKPlayer *> *)players API_DEPRECATED("Use instance method loadEntriesForPlayers:timeScope:completionHandler: instead.", ios(8.0, 14.0), tvos(9.0, 14.0), macosx(10.10, 10.16), watchos(2.0, 7.0));

/// Load the scores for this leader board asynchronously. Error will be nil on success.
/// Possible reasons for error:
/// 1. Communications problem
/// 2. Unauthenticated player
- (void)loadScoresWithCompletionHandler:(void(^__nullable)(NSArray<GKScore *> * __nullable scores, NSError * __nullable error))completionHandler API_DEPRECATED("Use loadEntriesForPlayerScope:timeScope:range:completionHandler:.", ios(4.0, 14.0), tvos(9.0, 14.0), macosx(10.8, 10.16), watchos(3.0, 7.0));
...
+ (void)loadLeaderboardsWithCompletionHandler:(void(^__nullable)(NSArray<GKLeaderboard *> * __nullable leaderboards, NSError * __nullable error))completionHandler  API_DEPRECATED("Use class method loadLeaderboardsWithIDs:completionHandler:", ios(6.0, 14.0), tvos(9.0, 14.0), macosx(10.8, 10.16), watchos(2.0, 7.0));
