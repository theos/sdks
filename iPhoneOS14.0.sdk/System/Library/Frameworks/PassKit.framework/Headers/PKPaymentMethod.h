...
@property (nonatomic, copy, readonly, nullable) PKPaymentPass *paymentPass API_DEPRECATED("Use -[PKPass secureElementPass] instead", macos(10.16, API_TO_BE_DEPRECATED), ios(8.0, API_TO_BE_DEPRECATED), watchos(3.0, API_TO_BE_DEPRECATED));
@property (nonatomic, copy, readonly, nullable) PKSecureElementPass *secureElementPass API_AVAILABLE(ios(13.4), macos(10.16), watchos(6.2));

// A partially redacted billing address. Only available if no shipping address info was requested.
@property (nonatomic, copy, readonly, nullable) CNContact *billingAddress API_AVAILABLE(ios(13.0), macos(10.16), watchos(6.0));
