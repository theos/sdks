...
typedef NS_OPTIONS(NSUInteger, PKMerchantCapability) {
    ...
    PKMerchantCapabilityCredit NS_ENUM_AVAILABLE(10_16, 9_0) = 1UL << 2,   // Merchant supports credit
    PKMerchantCapabilityDebit  NS_ENUM_AVAILABLE(10_16, 9_0) = 1UL << 3    // Merchant supports debit
...
typedef NS_OPTIONS(NSUInteger, PKAddressField) {
    ...
    PKAddressFieldName NS_ENUM_AVAILABLE(10_16, 8_3) = 1UL << 3,
...
}  API_AVAILABLE(macos(10.16), ios(9.0), watchos(3.0));
...
+ (instancetype)summaryItemWithLabel:(NSString *)label amount:(NSDecimalNumber *)amount type:(PKPaymentSummaryItemType)type API_AVAILABLE(macos(10.16), ios(9.0), watchos(3.0));
...
@property (nonatomic, assign) PKPaymentSummaryItemType type API_AVAILABLE(macos(10.16), ios(9.0), watchos(3.0));
...
+ (NSArray<PKPaymentNetwork> *)availableNetworks API_AVAILABLE(macos(10.16), ios(10.0), watchos(3.0));
...
+ (NSError *)paymentContactInvalidErrorWithContactField:(PKContactField)field
                                   localizedDescription:(nullable NSString *)localizedDescription API_AVAILABLE(macos(10.16), ios(11.0), watchos(4.0));
...
+ (NSError *)paymentShippingAddressUnserviceableErrorWithLocalizedDescription:(nullable NSString *)localizedDescription API_AVAILABLE(macos(10.16), ios(11.0), watchos(4.0));
...
@property (nonatomic, strong) NSSet<PKContactField> *requiredBillingContactFields API_AVAILABLE(macos(10.16), ios(11.0), watchos(4.0));
...
@property (nonatomic, strong, nullable) PKContact *billingContact API_AVAILABLE(macos(10.16), ios(9.0), watchos(3.0));

// Indicates which shipping contact fields the merchant requires in order to process a transactions
//
@property (nonatomic, strong) NSSet<PKContactField> *requiredShippingContactFields API_AVAILABLE(macos(10.16), ios(11.0), watchos(4.0));
...
@property (nonatomic, strong, nullable) PKContact *shippingContact API_AVAILABLE(macos(10.16), ios(9.0), watchos(3.0));
...
@property (nonatomic, assign) PKShippingType shippingType API_AVAILABLE(macos(10.16), ios(8.3), watchos(3.0));
