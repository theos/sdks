...
typedef NS_ENUM(NSUInteger, PKPassType) {
    PKPassTypeBarcode,
    PKPassTypeSecureElement API_AVAILABLE(macos(10.16), ios(13.4), watchos(6.2)),
...
@property (nonatomic, assign, readonly) PKPassType           passType API_AVAILABLE(macos(10.16), ios(8.0), watchos(3.0));
@property (nonatomic, readonly, nullable) PKPaymentPass      *paymentPass API_DEPRECATED("Use -[PKPass secureElementPass] instead", macos(10.16, API_TO_BE_DEPRECATED), ios(8.0, API_TO_BE_DEPRECATED), watchos(3.0, API_TO_BE_DEPRECATED));
@property (nonatomic, readonly, nullable) PKSecureElementPass *secureElementPass API_AVAILABLE(macos(10.16), ios(13.4), watchos(6.2));
...
@property (nonatomic, copy, readonly, nullable) NSDictionary *userInfo API_AVAILABLE(macos(10.16), ios(7.0), watchos(3.0));

@property (nonatomic, copy, readonly, nullable) NSURL *passURL; // open to view pass in Wallet app

@property (nonatomic, assign, readonly, getter=isRemotePass)   BOOL       remotePass API_AVAILABLE(macos(10.16), ios(9.0), watchos(3.0));
@property (nonatomic, copy, readonly)                          NSString   *deviceName API_AVAILABLE(macos(10.16), ios(9.0), watchos(3.0));
