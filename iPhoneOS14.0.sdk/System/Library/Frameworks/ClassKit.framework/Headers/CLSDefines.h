...
CLS_EXTERN NSString * const CLSErrorCodeDomain API_AVAILABLE(ios(11.3), macos(10.16), macCatalyst(14.0)) API_UNAVAILABLE(watchos, tvos);
...
typedef NSString * CLSErrorUserInfoKey NS_EXTENSIBLE_STRING_ENUM API_AVAILABLE(ios(11.3), macos(10.16), macCatalyst(14.0)) API_UNAVAILABLE(watchos, tvos);

/*!
 @abstract   Any object that caused a failure will be available in - [NSError userInfo]; under this key.
 */
CLS_EXTERN CLSErrorUserInfoKey const CLSErrorObjectKey API_AVAILABLE(ios(11.3), macos(10.16), macCatalyst(14.0)) API_UNAVAILABLE(watchos, tvos);
 ...
 */
CLS_EXTERN CLSErrorUserInfoKey const CLSErrorUnderlyingErrorsKey API_AVAILABLE(ios(11.3), macos(10.16), macCatalyst(14.0)) API_UNAVAILABLE(watchos, tvos);

typedef NSString * CLSPredicateKeyPath NS_EXTENSIBLE_STRING_ENUM API_AVAILABLE(ios(11.3), macos(10.16), macCatalyst(14.0)) API_UNAVAILABLE(watchos, tvos);

CLS_EXTERN CLSPredicateKeyPath const CLSPredicateKeyPathDateCreated API_AVAILABLE(ios(11.3), macos(10.16), macCatalyst(14.0)) API_UNAVAILABLE(watchos, tvos);
CLS_EXTERN CLSPredicateKeyPath const CLSPredicateKeyPathIdentifier API_AVAILABLE(ios(11.3), macos(10.16), macCatalyst(14.0)) API_UNAVAILABLE(watchos, tvos);
CLS_EXTERN CLSPredicateKeyPath const CLSPredicateKeyPathTitle API_AVAILABLE(ios(11.3), macos(10.16), macCatalyst(14.0)) API_UNAVAILABLE(watchos, tvos);
CLS_EXTERN CLSPredicateKeyPath const CLSPredicateKeyPathUniversalLinkURL API_AVAILABLE(ios(11.3), macos(10.16), macCatalyst(14.0)) API_UNAVAILABLE(watchos, tvos);
CLS_EXTERN CLSPredicateKeyPath const CLSPredicateKeyPathTopic API_AVAILABLE(ios(11.3), macos(10.16), macCatalyst(14.0)) API_UNAVAILABLE(watchos, tvos);
CLS_EXTERN CLSPredicateKeyPath const CLSPredicateKeyPathParent API_AVAILABLE(ios(11.3), macos(10.16), macCatalyst(14.0)) API_UNAVAILABLE(watchos, tvos);
