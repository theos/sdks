...
typedef NS_ENUM(NSInteger, CLSContextType) {
    ...
    CLSContextTypeCourse API_AVAILABLE(ios(13.4), macos(10.16), macCatalyst(14.0)) API_UNAVAILABLE(watchos, tvos),
    CLSContextTypeCustom API_AVAILABLE(ios(13.4), macos(10.16), macCatalyst(14.0)) API_UNAVAILABLE(watchos, tvos)
} API_AVAILABLE(ios(11.3), macos(10.16), macCatalyst(14.0)) API_UNAVAILABLE(watchos, tvos);

typedef NSString * CLSContextTopic NS_STRING_ENUM API_AVAILABLE(ios(11.3), macos(10.16), macCatalyst(14.0)) API_UNAVAILABLE(watchos, tvos);

CLS_EXTERN CLSContextTopic const CLSContextTopicMath API_AVAILABLE(ios(11.3), macos(10.16), macCatalyst(14.0)) API_UNAVAILABLE(watchos, tvos);
CLS_EXTERN CLSContextTopic const CLSContextTopicScience API_AVAILABLE(ios(11.3), macos(10.16), macCatalyst(14.0)) API_UNAVAILABLE(watchos, tvos);
CLS_EXTERN CLSContextTopic const CLSContextTopicLiteracyAndWriting API_AVAILABLE(ios(11.3), macos(10.16), macCatalyst(14.0)) API_UNAVAILABLE(watchos, tvos);
CLS_EXTERN CLSContextTopic const CLSContextTopicWorldLanguage API_AVAILABLE(ios(11.3), macos(10.16), macCatalyst(14.0)) API_UNAVAILABLE(watchos, tvos);
CLS_EXTERN CLSContextTopic const CLSContextTopicSocialScience API_AVAILABLE(ios(11.3), macos(10.16), macCatalyst(14.0)) API_UNAVAILABLE(watchos, tvos);
CLS_EXTERN CLSContextTopic const CLSContextTopicComputerScienceAndEngineering API_AVAILABLE(ios(11.3), macos(10.16), macCatalyst(14.0)) API_UNAVAILABLE(watchos, tvos);
CLS_EXTERN CLSContextTopic const CLSContextTopicArtsAndMusic API_AVAILABLE(ios(11.3), macos(10.16), macCatalyst(14.0)) API_UNAVAILABLE(watchos, tvos);
CLS_EXTERN CLSContextTopic const CLSContextTopicHealthAndFitness API_AVAILABLE(ios(11.3), macos(10.16), macCatalyst(14.0)) API_UNAVAILABLE(watchos, tvos);
 ...
 */
@property (nonatomic, copy, readonly) NSArray<NSString *> *identifierPath API_AVAILABLE(ios(13.4), macos(10.16), macCatalyst(14.0)) API_UNAVAILABLE(watchos, tvos);
 ...
 */
@property (nonatomic, strong, nullable) NSURL *universalLinkURL API_AVAILABLE(ios(11.4), macos(10.16), macCatalyst(14.0)) API_UNAVAILABLE(watchos, tvos);
 ...
 */
@property (nonatomic, copy, nullable) NSString *customTypeName API_AVAILABLE(ios(13.4), macos(10.16), macCatalyst(14.0)) API_UNAVAILABLE(watchos, tvos);
 ...
 */
@property (nonatomic, assign, readwrite, getter=isAssignable) BOOL assignable API_AVAILABLE(ios(14), macos(10.16), macCatalyst(14.0)) API_UNAVAILABLE(watchos, tvos);
 ...
 */
@property (nonatomic, assign, readwrite)  NSRange suggestedAge API_AVAILABLE(ios(14), macos(10.16), macCatalyst(14.0)) API_UNAVAILABLE(watchos, tvos);
 ...
 */
@property (nonatomic, assign, readwrite) NSRange suggestedCompletionTime API_AVAILABLE(ios(14), macos(10.16), macCatalyst(14.0)) API_UNAVAILABLE(watchos, tvos);
 ...
 */
@property (nonatomic, copy, readonly) NSSet<CLSProgressReportingCapability *> *progressReportingCapabilities API_AVAILABLE(ios(14), macos(10.16), macCatalyst(14.0)) API_UNAVAILABLE(watchos, tvos);
 ...
 */
@property (nonatomic, copy, nullable) NSString *summary API_AVAILABLE(ios(13.4), macos(10.16), macCatalyst(14.0)) API_UNAVAILABLE(watchos, tvos);
 ...
 */
@property (nonatomic, nullable) CGImageRef thumbnail API_AVAILABLE(ios(13.4), macos(10.16), macCatalyst(14.0)) API_UNAVAILABLE(watchos, tvos);
 ...
 */
- (void)setType:(CLSContextType)type API_AVAILABLE(ios(14), macos(10.16), macCatalyst(14.0)) API_UNAVAILABLE(watchos, tvos);
 ...
 */
- (void)addProgressReportingCapabilities:(NSSet<CLSProgressReportingCapability *> *)capabilities API_AVAILABLE(ios(14), macos(10.16), macCatalyst(14.0)) API_UNAVAILABLE(watchos, tvos);
 ...
 */
- (void)resetProgressReportingCapabilities API_AVAILABLE(ios(14), macos(10.16), macCatalyst(14.0)) API_UNAVAILABLE(watchos, tvos);
