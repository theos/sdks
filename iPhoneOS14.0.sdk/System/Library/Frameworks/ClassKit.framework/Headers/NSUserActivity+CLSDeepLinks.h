 ...
 */
@property (nonatomic, assign, readonly) BOOL isClassKitDeepLink API_AVAILABLE(ios(11.3), macos(10.16), macCatalyst(14.0)) API_UNAVAILABLE(watchos, tvos);
 ...
 */
@property (nullable, nonatomic, strong, readonly) NSArray<NSString *> *contextIdentifierPath API_AVAILABLE(ios(11.3), macos(10.16), macCatalyst(14.0)) API_UNAVAILABLE(watchos, tvos);
