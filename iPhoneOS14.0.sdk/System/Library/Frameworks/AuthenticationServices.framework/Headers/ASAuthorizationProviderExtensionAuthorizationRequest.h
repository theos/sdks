...
*/
AS_EXTERN ASAuthorizationProviderAuthorizationOperation const ASAuthorizationProviderAuthorizationOperationConfigurationRemoved API_AVAILABLE(ios(14.0), macos(10.16)) API_UNAVAILABLE(macCatalyst, watchos, tvos);
 ...
 */
@property (nonatomic, readonly, getter=isCallerManaged) BOOL callerManaged API_AVAILABLE(ios(14.0), macos(10.16)) API_UNAVAILABLE(macCatalyst, watchos, tvos);

/*! @abstract Team identifier of the calling application.
 */
@property (nonatomic, readonly) NSString *callerTeamIdentifier API_AVAILABLE(ios(14.0), macos(10.16)) API_UNAVAILABLE(macCatalyst, watchos, tvos);

/*! @abstract Localized display name of the calling application.
 */
@property (nonatomic, readonly) NSString *localizedCallerDisplayName API_AVAILABLE(ios(14.0), macos(10.16)) API_UNAVAILABLE(macCatalyst, watchos, tvos);
