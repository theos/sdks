...
FOUNDATION_EXTERN ARSkeletonJointName const ARSkeletonJointNameNeck                            API_AVAILABLE(ios(14.0));
FOUNDATION_EXTERN ARSkeletonJointName const ARSkeletonJointNameLeftForearm                     API_AVAILABLE(ios(14.0));
FOUNDATION_EXTERN ARSkeletonJointName const ARSkeletonJointNameRightForearm                    API_AVAILABLE(ios(14.0));
FOUNDATION_EXTERN ARSkeletonJointName const ARSkeletonJointNameLeftUpLeg                       API_AVAILABLE(ios(14.0));
FOUNDATION_EXTERN ARSkeletonJointName const ARSkeletonJointNameRightUpLeg                      API_AVAILABLE(ios(14.0));
FOUNDATION_EXTERN ARSkeletonJointName const ARSkeletonJointNameLeftLeg                         API_AVAILABLE(ios(14.0));
FOUNDATION_EXTERN ARSkeletonJointName const ARSkeletonJointNameRightLeg                        API_AVAILABLE(ios(14.0));
FOUNDATION_EXTERN ARSkeletonJointName const ARSkeletonJointNameLeftEye                         API_AVAILABLE(ios(14.0));
FOUNDATION_EXTERN ARSkeletonJointName const ARSkeletonJointNameRightEye                        API_AVAILABLE(ios(14.0));
FOUNDATION_EXTERN ARSkeletonJointName const ARSkeletonJointNameLeftEar                         API_AVAILABLE(ios(14.0));
FOUNDATION_EXTERN ARSkeletonJointName const ARSkeletonJointNameRightEar                        API_AVAILABLE(ios(14.0));
