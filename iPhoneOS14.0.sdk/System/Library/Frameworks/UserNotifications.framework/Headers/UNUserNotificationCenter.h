...
typedef NS_OPTIONS(NSUInteger, UNNotificationPresentationOptions) {
    ...
    UNNotificationPresentationOptionAlert __API_DEPRECATED("Use UNNotificationPresentationOptionList | UNNotificationPresentationOptionBanner", macos(10.14, 10.16), ios(10.0, 14.0), watchos(3.0, 7.0), tvos(10.0, 14.0)) = (1 << 2),
    UNNotificationPresentationOptionList __API_AVAILABLE(macos(10.16), ios(14.0), watchos(7.0), tvos(14.0)) = (1 << 3),
    UNNotificationPresentationOptionBanner __API_AVAILABLE(macos(10.16), ios(14.0), watchos(7.0), tvos(14.0)) = (1 << 4),
} __API_AVAILABLE(macos(10.14), ios(10.0), watchos(3.0), tvos(10.0));
