...
} NS_SWIFT_NAME(AXCustomContent.Importance) API_AVAILABLE(ios(14.0), tvos(14.0), watchos(7.0), macos(10.16));

AX_EXTERN API_AVAILABLE(ios(14.0), tvos(14.0), watchos(7.0), macos(10.16))
...
API_AVAILABLE(ios(14.0), tvos(14.0), watchos(7.0), macos(10.16))
