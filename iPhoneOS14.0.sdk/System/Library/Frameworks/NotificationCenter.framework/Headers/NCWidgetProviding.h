...
- (void)widgetPerformUpdateWithCompletionHandler:(void (^)(NCUpdateResult result))completionHandler API_DEPRECATED("Use WidgetKit instead. Today View extensions have been deprecated.", ios(10.0, 14.0));
