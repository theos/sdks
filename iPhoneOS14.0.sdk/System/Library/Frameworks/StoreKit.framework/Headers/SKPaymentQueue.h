...
@property(nonatomic, readonly) NSArray <id <SKPaymentTransactionObserver>> *transactionObservers API_AVAILABLE(ios(14.0), macos(10.16), tvos(14.0), watchos(7.0));
...
- (BOOL)paymentQueue:(SKPaymentQueue *)queue shouldAddStorePayment:(SKPayment *)payment forProduct:(SKProduct *)product NS_SWIFT_NAME(paymentQueue(_:shouldAddStorePayment:for:)) API_AVAILABLE(ios(11.0), macos(10.16), macCatalyst(14.0)) API_UNAVAILABLE(watchos);
...
- (void)paymentQueue:(SKPaymentQueue *)queue didRevokeEntitlementsForProductIdentifiers:(NSArray<NSString *> *)productIdentifiers NS_SWIFT_NAME(paymentQueue(_:didRevokeEntitlementsForProductIdentifiers:)) API_AVAILABLE(ios(14.0), macos(10.16), tvos(14.0), watchos(7.0));
