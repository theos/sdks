...
/**
 ...
 @see sensorsActive
 */
@property (nonatomic, readonly) BOOL sensorsRequireManualActivation API_AVAILABLE(macos(10.16), ios(14.0), tvos(14.0));
...
*/
@property (nonatomic) BOOL sensorsActive API_AVAILABLE(macos(10.16), ios(14.0), tvos(14.0));
 ...
 */
@property (nonatomic, readonly) BOOL hasAttitudeAndRotationRate API_DEPRECATED("hasAttitudeAndRotationRate has been deprecated, use -hasAttitude and -hasRotationRate instead", macos(10.13, 10.16), ios(11.0, 14.0), tvos(11.0, 14.0));
 ...
 */
@property (nonatomic, readonly) BOOL hasAttitude API_AVAILABLE(macos(10.16), ios(14.0), tvos(14.0));
 ...
 */
@property (nonatomic, readonly) BOOL hasRotationRate API_AVAILABLE(macos(10.16), ios(14.0), tvos(14.0));
