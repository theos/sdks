...
/**
 ...
 @see GCMouse.mice
 */
GAMECONTROLLER_EXTERN NSString *const GCMouseDidConnectNotification API_AVAILABLE(macos(10.16), ios(14.0));
GAMECONTROLLER_EXTERN NSString *const GCMouseDidDisconnectNotification API_AVAILABLE(macos(10.16), ios(14.0));
...
@see GCMouse.current
*/
GAMECONTROLLER_EXTERN NSString *const GCMouseDidBecomeCurrentNotification API_AVAILABLE(macos(10.16), ios(14.0));
GAMECONTROLLER_EXTERN NSString *const GCMouseDidStopBeingCurrentNotification API_AVAILABLE(macos(10.16), ios(14.0));
