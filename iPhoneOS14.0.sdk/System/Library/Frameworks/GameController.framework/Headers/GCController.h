...
@see GCController.controllers
*/
GAMECONTROLLER_EXTERN NSString *const GCControllerDidBecomeCurrentNotification API_AVAILABLE(macos(10.16), ios(14.0), tvos(14.0));
GAMECONTROLLER_EXTERN NSString *const GCControllerDidStopBeingCurrentNotification API_AVAILABLE(macos(10.16), ios(14.0), tvos(14.0));
 ...
 */
@property (class, atomic, strong, readonly, nullable) GCController *current API_AVAILABLE(macos(10.16), ios(14.0), tvos(14.0));
 ...
 */
@property (nonatomic, copy, readonly, nullable) GCDeviceBattery *battery API_AVAILABLE(macos(10.16), ios(14.0), tvos(14.0));
 ...
 */
@property (nonatomic, retain, readonly, nullable) GCDeviceLight *light API_AVAILABLE(macos(10.16), ios(14.0), tvos(14.0));
 ...
 */
@property (nonatomic, retain, readonly, nullable) GCDeviceHaptics *haptics API_AVAILABLE(macos(10.16), ios(14.0), tvos(14.0));
 ...
 */
+ (BOOL)supportsHIDDevice:(IOHIDDeviceRef)device API_AVAILABLE(macos(10.16)) API_UNAVAILABLE(ios, tvos);
#endif
