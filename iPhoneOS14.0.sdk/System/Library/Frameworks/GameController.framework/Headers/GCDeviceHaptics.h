...
/**
 ...
 @see GCDeviceHaptics
*/
typedef NSString* GCHapticsLocality NS_TYPED_ENUM API_AVAILABLE(macos(10.16), ios(14.0), tvos(14.0));
GAMECONTROLLER_EXTERN GCHapticsLocality const GCHapticsLocalityDefault API_AVAILABLE(macos(10.16), ios(14.0), tvos(14.0)); // guaranteed to be supported
GAMECONTROLLER_EXTERN GCHapticsLocality const GCHapticsLocalityAll API_AVAILABLE(macos(10.16), ios(14.0), tvos(14.0)); // guaranteed to be supported
GAMECONTROLLER_EXTERN GCHapticsLocality const GCHapticsLocalityHandles API_AVAILABLE(macos(10.16), ios(14.0), tvos(14.0));
GAMECONTROLLER_EXTERN GCHapticsLocality const GCHapticsLocalityLeftHandle API_AVAILABLE(macos(10.16), ios(14.0), tvos(14.0));
GAMECONTROLLER_EXTERN GCHapticsLocality const GCHapticsLocalityRightHandle API_AVAILABLE(macos(10.16), ios(14.0), tvos(14.0));
GAMECONTROLLER_EXTERN GCHapticsLocality const GCHapticsLocalityTriggers API_AVAILABLE(macos(10.16), ios(14.0), tvos(14.0));
GAMECONTROLLER_EXTERN GCHapticsLocality const GCHapticsLocalityLeftTrigger API_AVAILABLE(macos(10.16), ios(14.0), tvos(14.0));
GAMECONTROLLER_EXTERN GCHapticsLocality const GCHapticsLocalityRightTrigger API_AVAILABLE(macos(10.16), ios(14.0), tvos(14.0));
