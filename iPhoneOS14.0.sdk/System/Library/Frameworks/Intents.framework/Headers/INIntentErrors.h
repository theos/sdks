...
INTENTS_EXTERN NSString * const INIntentErrorDomain API_AVAILABLE(ios(10.0), macos(10.16), watchos(3.2), tvos(14.0));
...
} API_AVAILABLE(ios(10.0), macos(10.16), watchos(3.2), tvos(14.0));
