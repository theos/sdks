...
- (instancetype)initWithRecipients:(nullable NSArray<INPerson *> *)recipients
            ...
            conversationIdentifier:(nullable NSString *)conversationIdentifier
                       serviceName:(nullable NSString *)serviceName
                            sender:(nullable INPerson *)sender API_DEPRECATED("Use the designated initializer with outgoingMessageType instead", ios(11.0, 14.0), watchos(4.0, 7.0), macosx(10.13, 10.16));
...
- (instancetype)initWithRecipients:(nullable NSArray<INPerson *> *)recipients
            ...
            conversationIdentifier:(nullable NSString *)conversationIdentifier
                       serviceName:(nullable NSString *)serviceName
                            sender:(nullable INPerson *)sender API_DEPRECATED("Use the designated initializer with attachments instead instead", ios(14.0, 14.0), watchos(7.0, 7.0), macosx(10.16, 10.16));
