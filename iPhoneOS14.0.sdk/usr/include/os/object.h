...
/* Declares a protocol. Declares a subclass of the same name, and subclass
 * adheres to protocol. Typedefs baseclass<proto> * to subclass##_t */
#define OS_OBJECT_SHOW_SUBCLASS(subclass_name, super, proto_name, ...) \
		OS_OBJECT_DECL_PROTOCOL(proto_name, ## __VA_ARGS__); \
