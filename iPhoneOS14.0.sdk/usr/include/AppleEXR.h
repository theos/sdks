...
// To be removed: Not needed for external consumption
#define _AXR_APPLE_INTERNAL_API_NUMBER 2
...
#else
#   define AXR_AVAILABILITY_v1          __API_AVAILABLE(macos(10.16), ios(14.0), tvos(14.0), watchos(7.0))
#   define AXR_ENUM_AVAILABILITY_v1     __API_AVAILABLE(macos(10.16), ios(14.0), tvos(14.0), watchos(7.0))
#endif
...
typedef struct
{
    ...
    union
    {
        ...
        } primaries  __attribute__ ((deprecated));   // Deprecated, use chromaticities instead
        struct{
            struct{ float red, green, blue, white;} x;
            struct{ float red, green, blue, white;} y;
 ...
 *              in a CGImageRef, CGColorConversionInfoRef or a CGContextRef. Constant value channels will
 *              be ignored because they are unnamed and unidentified.  Note that if the data is YCbCr, the CGColorSpaceRef
 *              for the corresponding RGB colorspace is returned.
 *  @param      decoder   A valid axr_decoder_t
 ...
 *  @param   pLinear          (Poorly described in EXR. Needs work.)
...
void axr_part_append_channels( __nonnull axr_part_t part,
                               ...
                               uint32_t ySampling,
                               bool pLinear,
                               axr_channel_type_t channelList[__nonnull],
