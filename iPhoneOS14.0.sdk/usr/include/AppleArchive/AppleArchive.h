...
APPLE_ARCHIVE_AVAILABLE(macos(10.16), ios(14.0), watchos(7.0), tvos(14.0))
__attribute__((availability(macos,deprecated=10.16, replacement="AAByteStreamCancel")))
{ AAByteStreamCancel(s); }

APPLE_ARCHIVE_INLINE void AACustomByteStreamSetAbortProc(AAByteStream s, AAByteStreamCancelProc proc)
APPLE_ARCHIVE_AVAILABLE(macos(10.16), ios(14.0), watchos(7.0), tvos(14.0))
__attribute__((availability(macos,deprecated=10.16, replacement="AACustomByteStreamSetCancelProc")))
{ AACustomByteStreamSetCancelProc(s, proc); }

APPLE_ARCHIVE_INLINE void AAArchiveStreamAbort(AAArchiveStream s)
APPLE_ARCHIVE_AVAILABLE(macos(10.16), ios(14.0), watchos(7.0), tvos(14.0))
__attribute__((availability(macos,deprecated=10.16, replacement="AAArchiveStreamCancel")))
...
APPLE_ARCHIVE_AVAILABLE(macos(10.16), ios(14.0), watchos(7.0), tvos(14.0))
__attribute__((availability(macos,deprecated=10.16, replacement="AACustomArchiveStreamSetCancelProc")))
